...
"%EXECUTABLE%" //US//%SERVICE_NAME% --JvmOptions "-Dcatalina.base=%CATALINA_BASE%;-Dcatalina.home=%CATALINA_HOME%;-Djava.endorsed.dirs=%CATALINA_HOME%\common\endorsed;-Dorg.apache.commons.logging.Log=org.apache.commons.logging.impl.SimpleLog;-Djava.security.auth.login.config=%CATALINA_HOME%\conf\jaas.conf" --StartMode jvm --StopMode jvm
