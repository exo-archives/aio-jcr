...
namespace exo_jcr.msofficeplugin
{
    public partial class MainControl : UserControl
    {
       ...
       private void setCurrentPath(String path)
       {
        ...
        public void saveClick(Word._Application app, String entered_filename)
        {
            ...
            else
            {
                ...
                String localNameToSave = (localFolder + entered_filename + ".doc").Replace('/', '\\');

                try
                {
                    object wFileName = localNameToSave;
                    object omissing = Missing.Value;
                    doc.SaveAs(ref wFileName, ref omissing, ref omissing, ref omissing, ref omissing,
                        ref omissing, ref omissing, ref omissing, ref omissing, ref omissing,
                        ref omissing, ref omissing, ref omissing, ref omissing, ref omissing, ref omissing);

                    
                    String filename = app.ActiveDocument.Name;
                    String remoteFileName = path.Substring(path.IndexOf("/" + connect.Workspace));
