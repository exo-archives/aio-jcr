...
public class PropertyList {
  ...
  public Element toXml(Document xmlDocument) {
    ...
    if (isAllProp()) {
      return xmlDocument.createElement(WebDavConstants.Dav.PREFIX
          + WebDavConstants.WebDavProp.ALLPROP);
    }

    Element propEl = xmlDocument.createElement(WebDavConstants.Dav.PREFIX
        + WebDavConstants.WebDavProp.PROP);
