...
public abstract class BrowseDialog extends PlugInDialog {
  ...
  public boolean launchBeforeOpen() {
    try {
      XFixedText xLabelHead = (XFixedText) UnoRuntime.queryInterface(XFixedText.class,
                                                                     xControlContainer.getControl(LBL_TABLEHEAD));
  ...
  protected void disableAll() {
    ...
    if (xControlContainer.getControl(COMBO_PATH) != null) {
      ((XWindow) UnoRuntime.queryInterface(XWindow.class, xControlContainer.getControl(COMBO_PATH))).setEnable(false);
    }
  }
  ...
  protected void enableAll() {
    ...
    if (xControlContainer.getControl(BTN_PREV) != null) {
      if (!"/".equals(currentPath)) {
        ((XWindow) UnoRuntime.queryInterface(XWindow.class, xControlContainer.getControl(BTN_PREV))).setEnable(true);
      }
    }
  ...
  protected class OpenThread extends Thread {
    ...
    public void run() {
      try {
        ...
        XComboBox xComboBox = (XComboBox) UnoRuntime.queryInterface(XComboBox.class,
