...
public class ViewVersions extends PlugInDialog {
  ...
  private boolean doReport() throws Exception {  
    ...
    davReport.setRequiredProperty(DavProp.DISPLAYNAME);
    davReport.setRequiredProperty(DavProp.GETCONTENTLENGTH);
    davReport.setRequiredProperty(DavProp.CREATIONDATE);
    davReport.setRequiredProperty(DavProp.CREATORDISPLAYNAME);
  ...
  class VersionComparer implements Comparator<ResponseDoc> {
    ...
    public int compare(ResponseDoc resp1, ResponseDoc resp2) {
      ...
      CreationDateProp creationDate1 = (CreationDateProp)resp1.getProperty(DavProp.CREATIONDATE);
      CreationDateProp creationDate2 = (CreationDateProp)resp2.getProperty(DavProp.CREATIONDATE);
      ...
      DisplayNameProp displayName1 = (DisplayNameProp)resp1.getProperty(DavProp.DISPLAYNAME);
      DisplayNameProp displayName2 = (DisplayNameProp)resp2.getProperty(DavProp.DISPLAYNAME);
...
//      return dn1.getDisplayName().compareToIgnoreCase(dn2.getDisplayName());
  ...
  private String formatLine(ResponseDoc response) {
    DisplayNameProp displayNameProperty = (DisplayNameProp)response.getProperty(DavProp.DISPLAYNAME);    
    ContentLengthProp contentLengthProperty = (ContentLengthProp)response.getProperty(DavProp.GETCONTENTLENGTH);
    CreationDateProp creationDateProperty = (CreationDateProp)response.getProperty(DavProp.CREATIONDATE);
    CreatorDisplayNameProp creatorDisplayName = (CreatorDisplayNameProp)response.getProperty(DavProp.CREATORDISPLAYNAME);
