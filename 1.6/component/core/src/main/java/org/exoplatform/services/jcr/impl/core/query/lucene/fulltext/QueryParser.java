...
// *   Clause ::= ["+", "-"] [<TERM> ":"] ( <TERM> | "(" Query ")" )
  ...
  jjtree.openNodeScope(jjtn000);int ret = CONJ_NONE;
    try {
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);int ret = MOD_NONE;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NOT:
      case PLUS:
 ...
 /*@bgen(jjtree) Query */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Vector clauses = new Vector();
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Query q;
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token term, boost=null, fuzzySlop=null, goop1, goop2;
