...
public class HtmlBuilder {
  ...
  private String getListHtml(String path, ArrayList<WebDavResource> resources) throws Exception {    
  ...
  public InputStream getHtml(String path, ArrayList<WebDavResource> resources) {    
