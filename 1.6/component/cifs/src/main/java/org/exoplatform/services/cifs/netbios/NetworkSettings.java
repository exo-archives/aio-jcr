...
/**
 * The network settings class contains various Windows Networking settings that
 * are needed by the NetBIOS and SMB layers.
 */
public class NetworkSettings {
	 ...
	 * 
	 * @param addr
	 *            TCP/IP address to set the broadcast mask for, in
