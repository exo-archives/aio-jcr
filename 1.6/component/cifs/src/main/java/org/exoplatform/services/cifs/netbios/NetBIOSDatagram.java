...
public class NetBIOSDatagram {
	...
	public final void SendDatagram(int dgramTyp, String fromName,
			...
			int userLen, int userOff, InetAddress addr, int port)
	 ...
	 */
	public final void SendDatagram(int dgramTyp, String fromName,
			String toName, byte[] userData, int userLen) throws IOException,
	...
	/**
	 * Send a datagram to the specified NetBIOS name using the supplised
	 * datagram socket.
	 * 
	 * @param dgramTyp
	 *            Datagram type
	...
	public final void setSourceName(String name) {
		...
		NetBIOSSession.EncodeName(name, NetBIOSName.FileServer, m_buf,
				NB_FROMNAME);
	}
