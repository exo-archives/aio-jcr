...
public class DeleteCommand extends RestCommand {
  ...
  public DeleteCommand(RestContext context, RestTemplate restTemplate) throws Exception {
    super(context, restTemplate);
    
    this.commandName = RestCommands.DELETE;
    
    Log.info("public DeleteCommand(RestContext context)");    
  }  
