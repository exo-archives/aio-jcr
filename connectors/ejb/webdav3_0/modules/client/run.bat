...
:ok
@set CLASSPATH=..\connector\target\exo.jcr.webdav.ejbconnector3_0.bean-1.10.2.jar
...
java -Djava.security.manager=default -Djava.security.policy=%JONAS_ROOT%\conf\java.policy org.objectweb.jonas.client.ClientContainer target\exo.jcr.webdav.ejbconnector3_0.client-1.10.2.jar
