...
-cp $JONAS_ROOT/lib/apps/exo.core.component.security.core-2.2.1-SNAPSHOT.jar:\
...
exo.jcr.connectors.ejb21.bean-1.11.1-SNAPSHOT.jar \
org.objectweb.jonas.client.ClientContainer exo.jcr.connectors.ejb21.client-1.11.1-SNAPSHOT.jar $1 $2
