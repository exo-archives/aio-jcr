...
:ok
@set CLASSPATH=..\connector\target\exo.jcr.connectors.ejb30.bean-1.10.8.jar
...
java -Djava.security.manager=default -Djava.security.policy=%JONAS_ROOT%\conf\java.policy org.objectweb.jonas.client.ClientContainer target\exo.jcr.connectors.ejb30.client-1.10.8.jar %1 %2
