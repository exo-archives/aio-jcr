...
-cp \
../connector/target/exo.jcr.connectors.ejb30.bean-1.11.2-SNAPSHOT.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.jcr.connectors.ejb30.client-1.11.2-SNAPSHOT.jar $1 $2
