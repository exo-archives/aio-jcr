...
-cp \
../connector/target/exo.jcr.connectors.ejb30.bean-1.10.3-SNAPSHOT.jar:\
$JONAS_ROOT/lib/apps/exo.core.component.security.core-2.1.5-SNAPSHOT.jar:\
$JONAS_ROOT/lib/apps/exo.ws.commons-1.3.3-SNAPSHOT.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.jcr.connectors.ejb30.client-1.10.3-SNAPSHOT.jar $1 $2
