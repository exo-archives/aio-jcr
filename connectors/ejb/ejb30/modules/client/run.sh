...
-cp \
../connector/target/exo.jcr.connectors.ejb30.bean-1.10.7.jar:\
$JONAS_ROOT/lib/apps/exo.core.component.security.core-2.1.8.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.jcr.connectors.ejb30.client-1.10.7.jar $1 $2
