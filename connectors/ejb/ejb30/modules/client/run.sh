...
-cp \
../connector/target/exo.jcr.webdav.ejbconnector3_0.bean-1.10.1.1.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.jcr.webdav.ejbconnector3_0.client-1.10.1.1.jar $1 $2
