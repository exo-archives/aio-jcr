...
-cp \
../connector/target/exo.jcr.connectors.ejb30.bean-1.11.2.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.jcr.connectors.ejb30.client-1.11.2.jar $1 $2
