...
-cp \
../connector/target/exo.jcr.connectors.ejb30.bean-1.11.1-SNAPSHOT.jar:\
$JONAS_ROOT/lib/apps/exo.core.component.security.core-2.2.1-SNAPSHOT.jar:\
...
org.objectweb.jonas.client.ClientContainer target/exo.jcr.connectors.ejb30.client-1.11.1-SNAPSHOT.jar $1 $2
