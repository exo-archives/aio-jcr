...
import org.exoplatform.services.jcr.rmi.api.iterator.ArrayEventIterator;
...
public class ClientEventPoll extends Thread {
  ...
  public synchronized EventListener[] getListeners() {
    return (EventListener[]) listenerMap.values().toArray(new EventListener[(listenerMap.size())]);
  }
