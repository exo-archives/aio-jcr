...
/**
 * Remote version of the JCR {@link javax.jcr.RangeIterator} interface. Used by
 * the
 * {@link org.exoplatform.services.jcr.rmi.impl.server.iterator.ServerIterator}
 * and
 * {@link org.exoplatform.services.jcr.rmi.api.client.iterator.ClientIterator}
 * classes to provide transparent RMI access to remote iterators.
 * <p>
 * This interface allows both the client and server side to control the amount
 * of buffering used to increase performance.
 */
