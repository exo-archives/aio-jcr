...
/**
 * A buffered remote iterator. Used to transfer a remote iterator reference along with a buffer of
 * the first few iterator elements in one network transmission.
 */
public class BufferIterator implements RemoteIterator, Serializable {
   ...
   * 
   * @param buffer
   *          first elements in the iterator
   * @param size
   *          total iterator size
   * @param remote
  ...
  /**
   * Skips the given number of elements. First discards elements from the element buffer and only
   * then contacts the remote iterator.
   * 
   * @param items
   *          number of items to skip
   * @throws IllegalArgumentException
   *           if <code>items</code> is negative
   ...
   */
  public void skip(long items) throws IllegalArgumentException,
