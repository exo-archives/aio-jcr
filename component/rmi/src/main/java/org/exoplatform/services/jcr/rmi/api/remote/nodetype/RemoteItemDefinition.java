...
/**
 * Remote version of the JCR {@link javax.jcr.nodetype.ItemDefinition ItemDef} interface. Used by
 * the {@link org.exoplatform.services.jcr.rmi.impl.server.ServerItemDefinition
 ...
 * {@link javax.jcr.nodetype.NodeType NodeType} return values are returned as remote references to
 * the {@link org.exoplatform.services.jcr.rmi.api.remote.RemoteNodeType RemoteNodeType} interface.
...
public interface RemoteItemDefinition extends Remote {
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.ItemDefinition#getDeclaringNodeType()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.ItemDefinition#getName() ItemDef.getName()}
   * method.
   * 
   * @return item name
   * @throws RemoteException
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.ItemDefinition#isAutoCreated()
   * ItemDef.isAutoCreate()} method.
   * 
   * @return <code>true</code> if the item is automatically created, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.ItemDefinition#isMandatory()
   * ItemDef.isMandatory()} method.
   * 
   * @return <code>true</code> if the item is mandatory, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.ItemDefinition#getOnParentVersion()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.ItemDefinition#isProtected()
   * ItemDef.isProtected()} method.
   * 
   * @return <code>true</code> if the item is protected, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
