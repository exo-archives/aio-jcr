...
/**
 * Remote version of the JCR {@link javax.jcr.nodetype.NodeType NodeType} interface. The methods in
...
public interface RemoteNodeType extends Remote {
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getName() NodeType.getName()} method.
   * 
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#isMixin() NodeType.isMixin()} method.
   * 
   * @return <code>true</code> if this is a mixin type, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#hasOrderableChildNodes()
   * NodeType.hasOrderableChildNodes()} method.
   * 
   * @return <code>true</code> if nodes of this type has orderable child nodes, <code>false</code>
   *         otherwise
   * @throws RemoteException
   *           on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getSupertypes()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getDeclaredSupertypes()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#isNodeType(String)
   * NodeType.isNodeType(String)} method.
   * 
   * @param type
   *          node type name
   * @return <code>true</code> if this node type is or extends the given node type,
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getPropertyDefs()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getDeclaredPropertyDefs()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getChildNodeDefs()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getDeclaredChildNodeDefs()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#canSetProperty(String,Value)
   ...
   * @param value
   *          property value
   * @return <code>true</code> if the property can be set, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#canAddChildNode(String)
   * NodeType.canAddChildNode(String)} method.
   * 
   * @param name
   *          child node name
   * @return <code>true</code> if the child node can be added, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#canAddChildNode(String,String)
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#canRemoveItem(String)
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeType#getPrimaryItemName()
