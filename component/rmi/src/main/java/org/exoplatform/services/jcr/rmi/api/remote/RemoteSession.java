...
/**
 * Remote version of the JCR {@link javax.jcr.Session Session} interface. Used
 * by the
 * {@link org.exoplatform.services.jcr.rmi.impl.server.ServerSession ServerSession}
 * and
 * {@link org.exoplatform.services.jcr.rmi.api.client.ClientSession ClientSession}
 ...
 * a corresponding Session method. In these cases the remote object will simply
 * forward the method call to the underlying Session instance. Complex return
 * values like workspaces and other objects are returned as remote references to
 * the corresponding remote interface. Simple return values and possible
 * exceptions are simply copied over the network to the client. RMI errors are
 * signalled with RemoteExceptions.
 * 
 * @see javax.jcr.Session
 * @see org.exoplatform.services.jcr.rmi.api.client.ClientSession
 * @see org.exoplatform.services.jcr.rmi.impl.server.ServerSession
 */
...
public interface RemoteSession extends Remote {
  ...
  /**
   * Returns the named attribute. Note that only serializable attribute values
   * can be transmitted over the network and that the client should have (or be
   * able to fetch) the object class to access the returned value. Failures to
   * meet these conditions are signalled with RemoteExceptions.
   * 
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Session#getItem(String) Session.getItem(String)} method.
   * 
  ...
  /**
   * Remote version of the {@link javax.jcr.Session#save() Session.save()}
   * method.
   * 
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Session#refresh(boolean) Session.refresh(boolean)} method.
   * 
  ...
  /**
   * Remote version of the {@link javax.jcr.Session#logout() Session.logout()}
   * method.
   * 
   * @throws RemoteException on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.Session#isLive() Session.isLive()}
   * method.
   * 
   * @return <code>true</code> if the session is live, <code>false</code>
   *         otherwise
   * @throws RemoteException on RMI errors
   */
   ...
   * @throws RemoteException on RMI errors
   */
  void checkPermission(String path, String actions) throws AccessControlException,
      RepositoryException, RemoteException;

  /**
   * Imports the system or document view XML data into a subtree of the
   * identified node. Note that the entire XML stream is transferred as a single
   * byte array over the network. This may cause problems with large XML
   * streams. The remote server will wrap the XML data into a
   * {@link java.io.ByteArrayInputStream ByteArrayInputStream} and feed it to
   * the normal importXML method.
   * 
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Session#getLockTokens() Session.getLockTokens()} method.
   * 
   * @return lock tokens
   * @throws RemoteException on RMI errors
   */
  ...
  /**
   * Exports the identified repository subtree as a system view XML stream. Note
   * that the entire XML stream is transferred as a single byte array over the
   * network. This may cause problems with large exports. The remote server uses
   * a {@link java.io.ByteArrayOutputStream ByteArrayOutputStream} to capture
   ...
   */
  byte[] exportSystemView(String path, boolean skipBinary, boolean noRecurse) throws IOException,
      RepositoryException, RemoteException;

  /**
   * Exports the identified repository subtree as a document view XML stream.
   * Note that the entire XML stream is transferred as a single byte array over
   * the network. This may cause problems with large exports. The remote server
   * uses a {@link java.io.ByteArrayOutputStream ByteArrayOutputStream} to
   * capture the XML data written by the normal exportDocView method.
   * 
   * @param path node path
   ...
   */
  byte[] exportDocumentView(String path, boolean skipBinary, boolean noRecurse) throws IOException,
      RepositoryException, RemoteException;
   ...
   * @throws RepositoryException
   */
  String[] getAllNamespacePrefixes() throws RepositoryException, RemoteException;
}
