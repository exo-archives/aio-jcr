...
/**
 * Remote version of the JCR {@link javax.jcr.RangeIterator} interface. This interface allows both
 * the client and server side to control the amount of buffering used to increase performance.
 */
