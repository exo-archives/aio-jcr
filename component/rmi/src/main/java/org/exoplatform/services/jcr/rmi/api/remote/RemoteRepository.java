...
/**
 * Remote version of the JCR {@link javax.jcr.Repository Repository} interface. Used by the
 * {@link org.exoplatform.services.jcr.rmi.impl.server.ServerRepository ServerRepository} and
 * {@link org.exoplatform.services.jcr.rmi.api.client.ClientRepository ClientRepository} adapters to
 ...
 * instance. {@link javax.jcr.Session Session} objects are returned as remote references to the
 * {@link RemoteSession RemoteSession} interface. Simple return values and possible exceptions are
...
public interface RemoteRepository extends Remote {
  /**
   * Remote version of the {@link javax.jcr.Repository#getDescriptor(String)
  ...
  /**
   * Remote version of the {@link javax.jcr.Repository#getDescriptorKeys()
  ...
  /**
   * Remote version of the {@link javax.jcr.Repository#login() Repository.login(} method.
   * 
  ...
  /**
   * Remote version of the {@link javax.jcr.Repository#login(String) Repository.login(String}
   * method.
   * 
   * @param workspace
   *          workspace name
  ...
  /**
   * Remote version of the {@link javax.jcr.Repository#login(Credentials)
  ...
  /**
   * Remote version of the {@link javax.jcr.Repository#login(Credentials,String)
