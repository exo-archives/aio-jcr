 ...
 * corresponding Node method. The remote object will simply forward the method
 * call to the underlying Node instance. Argument and return values, as well as
 * possible exceptions, are copied over the network. Compex return values (like
 * Nodes and Properties) are returned as remote references to the corresponding
 ...
 * interface. Clients should implement the type-specific setProperty methods by
 * wrapping the argument values into generic Value objects and calling the
 * generic setProperty methods. Note also that the Value objects must be
 * serializable and implemented using classes available on both the client and
 * server side.
 */
public interface RemoteNode extends RemoteItem {
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Node#getProperty(String) Node.getProperty(String)} method.
   * 
   * @param path relative path
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#getUUID() Node.getUUID()}
   * method.
   * 
   * @return node uuid
   * @throws RepositoryException on repository errors
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#getNodes() Node.getNodes()}
   * method.
   * 
   * @return child nodes
   * @throws RepositoryException on repository errors
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#hasNodes() Node.hasNodes()}
   * method.
   * 
   ...
   * 
   * @return <code>true</code> if this node has properties, <code>false</code>
   *         otherwise
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
   */
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Node#getMixinNodeTypes() Node.getMixinNodeTypes()} method.
   * 
   ...
   * 
   * @param type node type name
   * @return <code>true</code> if this node is an instance of the identified
   ...
   * @throws RemoteException on RMI errors
   */
  RemoteProperty setProperty(String name, Value value, int type) throws RepositoryException,
      RemoteException;
   ...
   * @throws RemoteException on RMI errors
   */
  RemoteProperty setProperty(String name, Value[] values) throws RepositoryException,
      RemoteException;
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Node#removeMixin(String) Node.removeMixin(String)} method.
   * 
   * @param name mixin type name
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
  ...
  /**
   * Remote version of the
   * {@link javax.jcr.Node#canAddMixin(String) Node.canAddMixin(String)} method.
   * 
   * @param name mixin type name
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#checkin() Node.checkin()}
   * method.
   * 
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#checkout() Node.checkout()}
   * method.
   * 
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
   ...
   * @throws RemoteException on RMI errors
   */
  RemoteIterator merge(String workspace, boolean bestEffort) throws RepositoryException,
      RemoteException;
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#getIndex() Node.getIndex()}
   * method.
   * 
   * @return node index
   * @throws RepositoryException on repository errors
   ...
   * @throws RemoteException on RMI errors
   */
  void restoreByUUID(String versionUUID, boolean removeExisting) throws RepositoryException,
      RemoteException;
   ...
   * @throws RemoteException on RMI errors
   */
  void restore(String versionUUID, String path, boolean removeExisting) throws RepositoryException,
      RemoteException;
   ...
   * @throws RemoteException on RMI errors
   */
  void restoreByLabel(String label, boolean removeExisting) throws RepositoryException,
      RemoteException;

  /**
   * Remote version of the {@link javax.jcr.Node#unlock() Node.unlock()} method.
   * 
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#holdsLock() Node.holdsLock()}
   * method.
   * 
   * @return <code>true</code> if this node holds a lock, <code>false</code>
   *         otherwise
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
   */
  ...
  /**
   * Remote version of the {@link javax.jcr.Node#isLocked() Node.isLocked()}
   * method.
   * 
   * @return <code>true</code> if this node is locked, <code>false</code>
   *         otherwise
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
   */
   ...
   * 
   * @return <code>true</code> if this node is checked out, <code>false</code>
   *         otherwise
   * @throws RepositoryException on repository errors
   * @throws RemoteException on RMI errors
   */
   ...
   * @throws RemoteException on RMI errors
   */
  RemoteProperty setProperty(String name, Value[] values, int type) throws RepositoryException,
      RemoteException;
   ...
   * @throws RemoteException on RMI errors
   */
  RemoteLock lock(boolean isDeep, boolean isSessionScoped) throws RepositoryException,
      RemoteException;

  /**
   * Remote version of the {@link javax.jcr.Node#getLock() Node.getLock()}
   * method.
   * 
   * @return lock
   * @throws RepositoryException on repository errors
