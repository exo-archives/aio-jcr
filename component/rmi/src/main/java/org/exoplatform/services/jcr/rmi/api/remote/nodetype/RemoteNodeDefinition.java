...
/**
 * Remote version of the JCR {@link javax.jcr.nodetype.NodeDefinition NodeDefinition} interface.
 * Used by the {@link org.exoplatform.services.jcr.rmi.impl.server.ServerNodeDefinition
...
public interface RemoteNodeDefinition extends RemoteItemDefinition {
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeDefinition#getRequiredPrimaryTypes()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeDefinition#getDefaultPrimaryType()
  ...
  /**
   * Remote version of the {@link javax.jcr.nodetype.NodeDefinition#allowsSameNameSiblings()
   * NodeDef.allowSameNameSibs()} method.
   * 
   * @return <code>true</code> if same name siblings are allowed, <code>false</code> otherwise
   * @throws RemoteException
   *           on RMI errors
   */
