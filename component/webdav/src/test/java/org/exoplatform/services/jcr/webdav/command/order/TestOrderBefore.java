...
public class TestOrderBefore extends OrderPatchTest {
  ...
  public void testOrderBefore2() throws Exception {
    ...
    String href1MustBe = TextUtil.escape("http://localhost" + orderBeforeNode.getPath() + "/n4", '%', true);
    ...
    String href2MustBe = TextUtil.escape("http://localhost" + orderBeforeNode.getPath() + "/n1", '%', true);
