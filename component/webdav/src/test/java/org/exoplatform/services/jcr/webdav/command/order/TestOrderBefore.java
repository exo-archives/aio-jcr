...
public class TestOrderBefore extends OrderPatchTest {
  ...
  public void testOrderBefore1() throws Exception {
    ...
    String xml = "" + "<D:orderpatch xmlns:D=\"DAV:\">" + "<D:order-member>"
        + "<D:segment>n3</D:segment>" + "<D:position>" + "<D:before>" + "<D:segment>n2</D:segment>"
        + "</D:before>" + "</D:position>" + "</D:order-member>" + "</D:orderpatch>";
  ...
  public void testOrderBefore2() throws Exception {
    ...
    String xml = "" + "<D:orderpatch xmlns:D=\"DAV:\">" + "<D:order-member>"
        + "<D:segment>n4</D:segment>" + "<D:position>" + "<D:before>" + "<D:segment>n2</D:segment>"
        + "</D:before>" + "</D:position>" + "</D:order-member>" +
