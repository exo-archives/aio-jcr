...
public class TestPropFindContent extends BaseStandaloneTest {
  ...
  public void testPropFindNamedProp() throws Exception {
    ...
    String xml = "" + "<D:propfind xmlns:D=\"DAV:\">"
        ...
        + "<jcr:content xmlns=\"\">"
        + "<webdav:outerProp xmlns:webdav=\"http://www.exoplatform.org/jcr/webdav\">"
        + "<webdav:innerProp/>" + "</webdav:outerProp>" + "</jcr:content>" + "</D:prop>"
        + "</D:propfind>";

    String path = node.getPath();
    ContainerResponse response = service(WebDAVMethods.PROPFIND,
                                         getPathWS() + path,
                                         "",
                                         null,
                                         xml.getBytes());
