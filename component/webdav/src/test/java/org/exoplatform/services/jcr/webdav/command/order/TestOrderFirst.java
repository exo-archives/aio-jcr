...
public class TestOrderFirst extends OrderPatchTest {
  ...
  public void testOrderFirst1() throws Exception {
    ...
    String xml = "" + "<D:orderpatch xmlns:D=\"DAV:\">" + "<D:order-member>"
        + "<D:segment>n3</D:segment>" + "<D:position><D:first/></D:position>" + "</D:order-member>"
        + "</D:orderpatch>";
  ...
  public void testOrderFirst2() throws Exception {
    ...
    String path = orderFirstNode.getPath();
    String xml = "" + "<D:orderpatch xmlns:D=\"DAV:\">" + "<D:order-member>"
        + "<D:segment>n1</D:segment>" + "<D:position><D:first/></D:position>" + "</D:order-member>"
        + "</D:orderpatch>";
    ContainerResponse response = service(WebDAVMethods.ORDERPATCH, getPathWS()
        + URLEncoder.encode(path, "UTF-8"), "", null, xml.getBytes());
    assertEquals(HTTPStatus.OK, response.getStatus());
  ...
  public void testOrderFirst3() throws Exception {
    ...
    String xml = "" + "<D:orderpatch xmlns:D=\"DAV:\">" + "<D:order-member>"
        + "<D:segment>n0</D:segment>" + "<D:position><D:first/></D:position>" + "</D:order-member>"
        + "</D:orderpatch>";
