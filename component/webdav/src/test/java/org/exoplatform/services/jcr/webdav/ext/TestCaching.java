...
//     {
//       name = TestUtils.getFullWorkSpacePath() + "/" + TestUtils.getFileName();
//       
//       HTTPResponse response = connection.Put(name, fileContent);       
//       assertEquals(HTTPStatus.CREATED, response.getStatusCode());
//       response = connection.Get(name);
//       assertEquals(cacheControlType.getCacheValue(), response.getHeader(WebDavConst.Headers.CACHECONTROL));
//       
//     }
//  }
