...
public class LinkGenerator {
  ...
  public static int[] linkHeader = {
      ...
      0x01, 0x14/* 0x04 */, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x46,
  ...
  private byte[] getFirstItem() throws IOException {
    ...
    int[] firstItem = { 0x1F, 0x50, 0xE0, 0x4F, 0xD0, 0x20, 0xEA, 0x3A, 0x69, 0x10, 0xA2, 0xD8,
  ...
  private byte[] getLastItem() throws IOException {
    ...
    int[] lastItem = { 0x2E, 0x80, 0x00, 0xDF, 0xEA, 0xBD, 0x65, 0xC2, 0xD0, 0x11, 0xBC, 0xED,
        0x00, 0xA0, 0xC9, 0x0A, 0xB5, 0x0F };
  ...
  private byte[] getRootHeader() throws IOException {
    ...
    int[] rootHeader = { 0x4C, 0x50, 0x00, 0x01, 0x42, 0x57, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  private byte[] getHreffedFolder(String itemName, String itemHref) throws IOException {
    ...
    int[] linkHrefHeader = { 0x4C, 0x50, 0x00, 0x22, 0x42, 0x57, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x40 };
  ...
  private byte[] getHreffedFile(String itemName, String itemHref) throws IOException {
    ...
    int[] attrs = { 0x4C, 0x50, 0x00, 0x22, 0x42, 0x57, 0xF0, 0x43, 0x1C, 0x29, 0xB6, 0x5C, 0xC7,
        0x01, 0x00, 0x7C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00 };
