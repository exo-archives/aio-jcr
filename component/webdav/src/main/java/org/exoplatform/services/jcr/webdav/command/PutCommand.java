...
public class PutCommand {
  ...
  public Response put(Session session, String path, InputStream inputStream,
      String nodeType, String mimeType, String updatePolicyType, List<String> tokens) {
    ...
    try {
      ...
      log.info("LockException. " + exc.getMessage(), exc);
