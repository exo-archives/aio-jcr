...
public class ExpandPropertyReporter implements DeltaVReporter {
  
  private static Log log = ExoLogger.getLogger("jcr.ExpandPropertyReporter");
  
  private ExpandPropertyReportDocument reportDocument;
  
  public ExpandPropertyReporter(ExpandPropertyReportDocument reportDocument) {
    log.info("Construct.......");
