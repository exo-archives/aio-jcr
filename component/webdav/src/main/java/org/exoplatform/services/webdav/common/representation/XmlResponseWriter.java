...
public class XmlResponseWriter implements SerializableEntity {
  ...
  private SerializableRepresentation serializable;
  
  public XmlResponseWriter(ManageableRepository repository, SerializableRepresentation serializable) {
  ...
  public void writeObject(OutputStream outputStream) throws IOException {
    try {      
      ...
      WebDavNameSpaceContext nameSpaceContext = new WebDavNameSpaceContext(repository);
