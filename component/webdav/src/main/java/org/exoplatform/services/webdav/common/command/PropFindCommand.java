  ...
  public Response propfind(
    ...
    try {
      ...
      if (requestRepresentation == null) {
        requestRepresentation = new PropFindRequestRepresentation(webDavService);
      }
      ...
      SerializableEntity entity = new XmlResponseWriter(repository, responseRepresentation);
