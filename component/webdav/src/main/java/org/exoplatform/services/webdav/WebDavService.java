...
public interface WebDavService {
  ...
  RequestRepresentationDispatcher getRequestDispatcher();
  
  PropertyRepresentation getPropertyRepresentation(String nameSpaceURI, String propertyName);
  
  void registerDocument(String nameSpace, String name, String className);
  
  void registerProperty(String nameSpace, String name, String className);
  
  HashMap<String, HashMap<String, String>> getDocuments();
