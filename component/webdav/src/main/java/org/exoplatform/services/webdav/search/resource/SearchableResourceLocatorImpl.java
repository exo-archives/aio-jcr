...
public class SearchableResourceLocatorImpl extends WebDavResourceLocatorImpl implements SearchableResourceLocator {
  ...
  public SearchableResourceLocatorImpl(WebDavService webDavService, String repositoryName, SessionProvider sessionProvider, ArrayList<String> lockTokens, String serverPrefix, String resourcePath) {
    super(webDavService, repositoryName, sessionProvider, lockTokens, serverPrefix, resourcePath);
  }
