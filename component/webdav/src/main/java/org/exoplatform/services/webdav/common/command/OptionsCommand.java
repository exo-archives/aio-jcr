...
public class OptionsCommand extends WebDavCommand {
  ...
  @HTTPMethod(WebDavMethod.OPTIONS)
  ...
  public Response options(
    ...
    try {
      ...
      WebDavResourceLocator resourceLocator = new WebDavResourceLocatorImpl(webDavService, sessionProvider, serverPrefix, null);      
  ...
  protected Response doOptions() throws Exception {
    ...
    ArrayList<String> availableCommands = webDavService.getAvailableCommands();
    ...
    return Response.Builder.ok().header(DavConst.Headers.ALLOW, allowedCommands).
        header(DavConst.Headers.DAV, DavConst.DAV_HEADER).
        header(DavConst.Headers.DASL, DavConst.DASL_VALUE).
        header(DavConst.Headers.MSAUTHORVIA, DavConst.DAV_MSAUTHORVIA).build();    
  }  
