...
public class MergePreviewReportDocument implements DeltaVReportDocument {
  
  private static Log log = ExoLogger.getLogger("jcr.MergePreviewReportDocument");
  
  public MergePreviewReportDocument() {
    log.info("Construct...........");
  }
  
  public DeltaVReporter getReporter() {
    
    log.info("return reporter...........");
    
    return new MergePreviewReporter(this);
  }
