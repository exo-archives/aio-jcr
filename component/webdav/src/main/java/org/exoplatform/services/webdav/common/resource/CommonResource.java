...
public abstract class CommonResource implements WebDavResource {
  ...
  private static Log log = ExoLogger.getLogger("jcr.CommonResource");
  
  protected String resourceHref;
  
  public CommonResource(WebDavService webDavService, String rootHref, String repoName) {
    log.info("Construct with default constructor!!!!!!");
    this.resourceHref = rootHref;
    
    log.info("Using href: [" + resourceHref + "]");
  }
