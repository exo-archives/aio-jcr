...
public class CheckedOutRepresentation extends WebDavPropertyRepresentation {
  
  private static Log log = ExoLogger.getLogger("jcr.CheckedOutRepresentation");
  
  public static final String TAGNAME = "checked-out";
  
  public CheckedOutRepresentation() {
    log.info("construct...");
  }
