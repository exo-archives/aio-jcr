...
import org.exoplatform.services.webdav.common.representation.property.NotFoundPropertyRepresentation;
...
public class WebDavServiceImpl implements WebDavService {
  ...
  public WebDavServiceImpl (
     ...
     * 
     */    
    registerDocument(DAV_NAMESPACE, PropFindRepresentation.TAGNAME, PropFindRepresentation.class.getCanonicalName());
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.services.webdav.WebDavService#getRepository()
