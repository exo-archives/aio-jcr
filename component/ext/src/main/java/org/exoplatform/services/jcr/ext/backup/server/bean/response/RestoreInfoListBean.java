 ...
 * @version $Id: RestoreInfoListBeen.java 111 2008-11-11 11:11:11Z rainf0x $
 */
public class RestoreInfoListBean {
  
  /**
   * The list of RestoreInfoBeen.
   */
  private Collection<RestoreInfoBean> restoresInfo;
  
  /**
   * RestoreInfoListBeen  constructor.
   *
   */
