...
public final class AsyncPacketTypes {
  ...
  /**
   * GET_EXPORT_CHAHGESLOG. the pocket type for request export data
   */
  public static final int GET_EXPORT_CHAHGESLOG  = 0;

  /**
   * EXPORT_CHANGES_PACKET. the pocket type for export data
   */
  public static final int EXPORT_CHANGES_PACKET  = 1;

  /**
   * CHANGESLOG_PACKET. the pocket type for Changeslog
   */
  public static final int CHANGESLOG_PACKET      = 2;

  /**
   * SYNCHRONIZATION_CANCEL. the pocket type to cancel synchronization
   */
  public static final int SYNCHRONIZATION_CANCEL = 3;

  /**
   * SYNCHRONIZATION_MERGE. the pocket type to done synchronization merge
   */
  public static final int SYNCHRONIZATION_MERGE  = 4;

  /**
   * EXPORT_ERROR. the pocket type to error for export
   */
