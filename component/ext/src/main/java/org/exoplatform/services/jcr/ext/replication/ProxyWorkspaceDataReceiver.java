...
public class ProxyWorkspaceDataReceiver extends AbstractWorkspaceDataReceiver {
  ...
  public ProxyWorkspaceDataReceiver( CacheableWorkspaceDataManager dataManager, SearchIndex searchIndex)
  throws RepositoryConfigurationException {
    this(dataManager, searchIndex, null);
  }
  ...
  public ProxyWorkspaceDataReceiver( CacheableWorkspaceDataManager dataManager, SearchIndex searchIndex, LockManagerImpl lockManager)
      throws RepositoryConfigurationException {
    dataKeeper = new WorkspaceDataManagerProxy(dataManager, searchIndex, lockManager);
  }
}
