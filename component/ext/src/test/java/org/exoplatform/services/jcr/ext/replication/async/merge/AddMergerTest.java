...
public class AddMergerTest extends BaseMergerTest {
  ...
  public void testAddNodeNoLocalChangesLocalPriority() throws Exception {
    ...
    AddMerger addMerger = new AddMerger(localMember, true, new TesterRemoteExporter(), dataManager, ntManager);
  ...
  public void testAddNodeNoLocalChangesRemotePriority() throws Exception {
    ...
    AddMerger addMerger = new AddMerger(localMember, false, new TesterRemoteExporter(), dataManager, ntManager);
    ChangesStorage<ItemState> result = addMerger.merge(remoteItem2Change,
                                                       income,
                                                       local,
                                                       "./target",
  ...
  public void testLocalParentRemovedRemotePriority() throws Exception {
    ...
    AddMerger addMerger = new AddMerger(localMember, false, new TesterRemoteExporter(exportLog), null, null);
    ChangesStorage<ItemState> result = addMerger.merge(remoteItem121Change,
                                                       income,
                                                       local,
                                                       "./target",
  ...
  public void testLocalRenamedRemotePriority4() throws Exception {
    ...
    AddMerger addMerger = new AddMerger(localMember, false,
  ...
  public void testLocalRenamedRemotePriority2() throws Exception {
    ...
    assertTrue("Local Delete state expected ", hasState(result, new ItemState(localItem21,
                                                                              ...
                                                                              false,
                                                                              null), true));
    assertTrue("Remote Add state expected ", hasState(result, remoteItem21Add, true));
  }
  ...
  public void testAddPropertySameNodeLocalPriority() throws Exception {
    ...
    AddMerger addMerger = new AddMerger(localMember, true,
