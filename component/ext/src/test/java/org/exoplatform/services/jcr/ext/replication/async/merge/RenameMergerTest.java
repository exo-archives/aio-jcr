...
public class RenameMergerTest extends BaseMergerTest {
  ...
  public void testAddLocalPriority() throws Exception {
    ...
    RenameMerger renameMerger = new RenameMerger(true, null, dataManager, ntManager, resHolder, fileCleaner, maxBufferSize, holder);
  ...
  public void testAddRemotePriority() throws Exception {
    ...
    RenameMerger renameMerger = new RenameMerger(false, null, dataManager, ntManager, resHolder, fileCleaner, maxBufferSize, holder);
    ChangesStorage<ItemState> result = renameMerger.merge(remoteItem11Deleted,
                                                          income,
                                                          local,
                                                          "./target",
