 ...
 */
public class TestTransmitterChanges extends BaseStandaloneTest {
  private static final String CH_CONFIG = "TCP(" + "start_port=7700;"
                                            ...
                                            + "oob_thread_pool.max_threads=20;" + "loopback=false;"
                                            ...
                                            + "enable_diagnostics=true;" + "max_bundle_timeout=30;"
                                            ...
                                            + "enable_bundling=true)" + ":MPING(" + "timeout=2000;"
                                            + "num_initial_members=8;" + "mcast_port=34526;"
                                            + "mcast_addr=224.0.0.1)" + ":FD(" + "timeout=2000;"
                                            + "max_tries=5;" + "shun=true)" + ":FD_SOCK"
                                            + ":VERIFY_SUSPECT(timeout=1500)" + ":pbcast.NAKACK("
                                            + "max_xmit_size=60000;"
                                            ...
                                            + "desired_avg_gossip=50000;" + "max_bytes=8000000)"
