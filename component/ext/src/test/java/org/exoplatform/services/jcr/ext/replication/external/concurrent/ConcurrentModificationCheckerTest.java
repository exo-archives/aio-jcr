...
public class ConcurrentModificationCheckerTest extends BaseTestCaseChecker {
  ...
  public void testTwoThreads() throws Exception {
    ...
    String fileName[] = new String[] { "nt_file_" + getRandomLong(), "nt_file_" + getRandomLong(),
        "nt_file_" + getRandomLong() };
    ...
    for (MemberInfo memberInfo : getAllMembers()) {
      ...
      {
        String url = "http://" + memberInfo.getIpAddress() + ":" + memberInfo.getPort()
            + ReplicationTestService.Constants.BASE_URL + "/" + workingRepository + "/"
