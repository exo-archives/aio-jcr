...
public class TestOrganizationServiceLDAP extends BaseStandaloneTest {
  ...
  public void testMembershipType() throws Exception {
    ...
    assertEquals("Expect 2 membership in collection: ", 2, ms.size());
    ...
    assertEquals("Expect 1 membership in collection: ", 1, mtHandler_.findMembershipTypes().size());
    ...
    assertEquals("Expect 0 membership in collection: ", 0, mtHandler_.findMembershipTypes().size());
