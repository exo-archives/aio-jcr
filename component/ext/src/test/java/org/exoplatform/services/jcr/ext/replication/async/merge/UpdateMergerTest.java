...
public class UpdateMergerTest extends BaseMergerTest {
  ...
  public void testAddLocalPriority() throws Exception {
    ...
    UpdateMerger updateMerger = new UpdateMerger(true, null, dataManager, ntManager, resHolder, fileCleaner, maxBufferSize, holder);
  ...
  public void testAddRemotePriority() throws Exception {
    ...
    UpdateMerger updateMerger = new UpdateMerger(false, null, dataManager, ntManager, resHolder, fileCleaner, maxBufferSize, holder);
    ChangesStorage<ItemState> result = updateMerger.merge(remoteItem21x2Remove,
                                                          income,
                                                          local,
                                                          "./target",
