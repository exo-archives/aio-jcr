...
public class BandwidthAllocationCheckerTest extends BaseTestCaseChecker {
  ...
  public void testAddEmptyNode() throws Exception {
    ...
    System.out.println("The time of the adding the empty nodes (" + baseNodesCount * simpleOperationCount + ") : " + ((end - start) / 1000) + " sec");
  ...
  public void testAddStringProperty() throws Exception {
    ...
    System.out.println("The time of the adding the string property (" + baseNodesCount * simpleOperationCount + ") : " + ((end - start) / 1000) + " sec");
