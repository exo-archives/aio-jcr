...
import java.javax.jcr.nodetype.InvalidNodeTypeDefinitionException;
import java.javax.jcr.nodetype.NodeTypeExistsException;
import java.javax.jcr.nodetype.NodeTypeIterator;
...
public interface ExtendedNodeTypeManager extends NodeTypeManager, NodeTypeDataManager {
   ...
   * <code>NodeTypeValue</code> objects. This method is used to register
   ...
   */
  public NodeTypeIterator registerNodeTypes(Collection<NodeTypeValue> values, int alreadyExistsBehaviour) throws InvalidNodeTypeDefinitionException, NodeTypeExistsException, UnsupportedRepositoryOperationException, RepositoryException;
  ...
  /**
   * Unregisters the specified set of node types.<p/> 
