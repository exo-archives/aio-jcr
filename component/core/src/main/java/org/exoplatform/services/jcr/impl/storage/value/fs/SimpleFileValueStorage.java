...
//            } else {
//              log.warn("Item data marked as deleted exists in repository with propertyId " + propertyId 
//                  + ". The 'phantom' marker file will be deleted but data file doesn't.");
//            }
//            if (!markerFile.delete())
//              log.warn("Can't delete 'phantom' marker file " + markerFile.getAbsolutePath());
//          } catch(RepositoryException e) {
//            log.error("Value file storage repository error of 'phantom' item data (" + propertyId + ") check. " + e.getMessage());
//          } catch(IllegalStateException e) {
//            log.error("Value file storage error of 'phantom' item data (" + propertyId + ") check. " + e.getMessage());
//          }
//        } else {
//          log.warn("Delete 'phantom' marker file (no 'phantom' file exists) " + markerFile.getAbsolutePath());
//          if (!markerFile.delete())
//            log.warn("Can't delete 'phantom' marker file (no 'phantom' file exists) " + markerFile.getAbsolutePath());        
//        }
//      }
//    }
}
