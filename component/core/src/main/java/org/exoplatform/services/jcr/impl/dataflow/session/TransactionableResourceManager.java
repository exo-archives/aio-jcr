 ...
 *         Nedonosko</a>
 * @version $Id: TransactionableResourceManager.java 26578 2009-01-10 12:12:56Z
 *          pnedonosko $
 */
public class TransactionableResourceManager {
  ...
  synchronized public void add(XASessionImpl userSession) {
    ...
    if (joinedList != null) {
      ...
      final List<SoftReference<XASessionImpl>> previous = putIfAbsent(userSession.getUserID(),
                                                                      newJoinedList);
      if (previous != null)
  ...
  private List<SoftReference<XASessionImpl>> putIfAbsent(String key,
                                                         List<SoftReference<XASessionImpl>> value) {
