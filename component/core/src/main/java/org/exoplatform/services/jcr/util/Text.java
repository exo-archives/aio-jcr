...
public class Text {
   ...
   * section 2.3 of the RFC 2396 'URI generic syntax':
   * <p/>
   * 
   * <pre>
   ...
   * <p/>
   * Please note, that this does not exactly the same as the url related {@link #unescape(String)},
   * since it handles the byte-encoding differently.
   * 
   * @param name
