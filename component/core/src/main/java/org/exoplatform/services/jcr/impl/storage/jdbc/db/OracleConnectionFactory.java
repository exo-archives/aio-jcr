...
public class OracleConnectionFactory extends GenericConnectionFactory {
  ...
  public OracleConnectionFactory(String dbDriver,
    ...
    Object cds = null;
    try {
      Class cdsClass = OracleConnectionFactory.class.getClassLoader()
                                                    .loadClass("oracle.jdbc.pool.OracleDataSource");
      ...
      Method setConnectionCachingEnabled = cds.getClass().getMethod("setConnectionCachingEnabled",
                                                                    new Class[] { boolean.class });
      setConnectionCachingEnabled.invoke(cds, new Object[] { true });

      Method setConnectionCacheProperties = cds.getClass()
                                               .getMethod("setConnectionCacheProperties",
                                                          new Class[] { Properties.class });
      setConnectionCacheProperties.invoke(cds, new Object[] { prop });

      Method setConnectionCacheName = cds.getClass().getMethod("setConnectionCacheName",
