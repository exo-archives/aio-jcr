...
public class JAASAuthenticator extends BaseAuthenticator {
  ...
  public final ConversationState authenticate(Credentials credentials) throws LoginException {
    ...
    CallbackHandler handler = new BasicCallbackHandler(thisCredentials
        .getUserID(), thisCredentials.getPassword());
    ...
    try {
      ...
      throw new LoginException("Login failed for " + thisCredentials.getUserID()
          + " " + e);
    }
