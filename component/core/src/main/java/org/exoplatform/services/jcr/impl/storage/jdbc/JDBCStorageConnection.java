   ...
   */
    ...
    private ItemData itemData(QPath parentPath, ResultSet item, int itemClass) throws RepositoryException, SQLException, IOException {
      ...
      try {
        if (itemClass == I_CLASS_NODE) {
          ...
          return loadNodeRecord(parentPath == null ? traverseQPath(cpid) : parentPath, // traverseQPath(cpid),  // TODO check with ora, mysql
        ...
        return loadPropertyRecord(parentPath == null ? traverseQPath(cpid) : parentPath, // traverseQPath(cpid),  // TODO check with ora, mysql
    ...
    private PropertyData propertyData(QPath parentPath, ResultSet item) throws RepositoryException, SQLException, IOException {
      ...
      try {
        ...
        QPath qpath = QPath.makeChildPath(parentPath == null ? traverseQPath(cpid) : parentPath, // traverseQPath(cpid), // TODO check with ora, mysql 
            qname);
