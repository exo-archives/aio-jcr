...
public class OraclePoolConnectionFactory extends GenericConnectionFactory {
  ...
  public OraclePoolConnectionFactory(String dbDriver,
    ...
    Object cpool = null;
    try {
      Class cpoolClass = OraclePoolConnectionFactory.class.getClassLoader()
                                                          .loadClass("oracle.jdbc.pool.OracleOCIConnectionPool");
      Constructor cpoolConstructor = cpoolClass.getConstructor(new Class[] { String.class,
          String.class, String.class, Properties.class });

      cpool = cpoolConstructor.newInstance(new Object[] { this.dbUserName, this.dbPassword,
          this.dbUrl, null });
      Method setConnectionCachingEnabled = cpool.getClass()
                                                .getMethod("setConnectionCachingEnabled",
  ...
  protected void reconfigure() throws NoSuchMethodException,
                              IllegalArgumentException,
                              IllegalAccessException,
                              InvocationTargetException,
    ...
    if (ociPool != null) {
      ...
      ociPool.getClass()
             .getMethod("setPoolConfig", new Class[] { Properties.class })
             .invoke(ociPool, new Object[] { p1 });
    }
  }
  ...
  protected void displayPoolConfig() throws NoSuchMethodException,
    ...
    if (ociPool != null) {
      ...
      log.info(" Min poolsize Limit:\t"
          + ociPool.getClass().getMethod("getMinLimit", new Class[] {}).invoke(ociPool,
                                                                               new Object[] {}));

      log.info(" Max poolsize Limit:\t"
          + ociPool.getClass().getMethod("getMaxLimit", new Class[] {}).invoke(ociPool,
                                                                               new Object[] {}));

      log.info(" PoolSize:\t\t\t"
          + ociPool.getClass().getMethod("getPoolSize", new Class[] {}).invoke(ociPool,
                                                                               new Object[] {}));

      log.info(" ActiveSize:\t\t"
          + ociPool.getClass().getMethod("getActiveSize", new Class[] {}).invoke(ociPool,
                                                                                 new Object[] {}));
    }
  }
