...
public class CQJDBCWorkspaceDataContainer extends JDBCWorkspaceDataContainer implements Startable {
   ...
   */
  public CQJDBCWorkspaceDataContainer(WorkspaceEntry wsConfig,
  ...
  protected void initDatabase() throws NamingException, RepositoryException, IOException {
    ...
    if (dbDialect == DBConstants.DB_DIALECT_ORACLEOCI) {
      ...
      if (dbSourceName != null) {
        ...
        this.connFactory = new HSQLDBConnectionFactory(dbDriver,
                                                       dbUrl,
                                                       dbUserName,
                                                       dbPassword,
                                                       containerName,
  ...
  protected GenericConnectionFactory defaultConnectionFactory() throws NamingException,
    ...
    if (dbSourceName != null) {
      DataSource ds = (DataSource) new InitialContext().lookup(dbSourceName);
      if (ds != null)
        return new GenericCQConnectionFactory(ds,
                                              containerName,
                                              multiDb,
                                              valueStorageProvider,
                                              maxBufferSize,
    ...
    return new GenericCQConnectionFactory(dbDriver,
                                          dbUrl,
                                          dbUserName,
                                          dbPassword,
                                          containerName,
