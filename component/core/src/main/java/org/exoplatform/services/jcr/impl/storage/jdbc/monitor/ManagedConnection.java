...
public class ManagedConnection implements Connection {
  ...
  public Statement createStatement(int resultSetType,
    ...
    return new ManagedStatement(jdbcConn.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), interest, LOG);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
    return new ManagedPreparedStatement(jdbcConn.prepareStatement(sql, resultSetType, resultSetConcurrency), sql, interest, LOG);
  }
  ...
  public PreparedStatement prepareStatement(String sql,
                                            ...
                                            int resultSetConcurrency,
                                            int resultSetHoldability) throws SQLException {
    return new ManagedPreparedStatement(jdbcConn.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), sql, interest, LOG);
  }
