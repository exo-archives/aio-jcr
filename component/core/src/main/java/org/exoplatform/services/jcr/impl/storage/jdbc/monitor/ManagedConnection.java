...
public class ManagedConnection implements Connection {
  ...
  public void commit() throws SQLException {
    ...
    if ((interest & ManagedConnection.COMMIT_INTREST) != 0)
      LOG.info(ManagedConnection.COMMIT_INTEREST_NAME + " - "
  ...
  public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
    return new ManagedStatement(jdbcConn.createStatement(resultSetType, resultSetConcurrency),
                                interest,
                                LOG);
  }
  ...
  public Statement createStatement(int resultSetType,
    ...
    return new ManagedStatement(jdbcConn.createStatement(resultSetType,
                                                         resultSetConcurrency,
                                                         resultSetHoldability), interest, LOG);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    return new ManagedPreparedStatement(jdbcConn.prepareStatement(sql, autoGeneratedKeys),
                                        sql,
                                        interest,
                                        LOG);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    return new ManagedPreparedStatement(jdbcConn.prepareStatement(sql, columnIndexes),
                                        sql,
                                        interest,
                                        LOG);
  }
  ...
  public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
    return new ManagedPreparedStatement(jdbcConn.prepareStatement(sql, columnNames),
                                        sql,
                                        interest,
                                        LOG);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
    return new ManagedPreparedStatement(jdbcConn.prepareStatement(sql,
                                                                  resultSetType,
                                                                  resultSetConcurrency),
                                        sql,
                                        interest,
