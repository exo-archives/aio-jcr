...
CREATE UNIQUE INDEX JCR_IDX_SITEM_NAME ON JCR_SITEM(NAME, CONTAINER_NAME, ID, VERSION);
...
CREATE UNIQUE INDEX JCR_IDX_SNODE_PARENTID ON JCR_SNODE(PARENT_ID, ID, NODE_INDEX);
