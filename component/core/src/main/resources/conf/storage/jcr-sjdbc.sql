...
CREATE UNIQUE INDEX JCR_IDX_SITEM_PATH ON JCR_SITEM(CONTAINER_NAME, PATH, VERSION DESC);
CREATE UNIQUE INDEX JCR_IDX_SITEM_PARENT_PATH ON JCR_SITEM(I_CLASS, CONTAINER_NAME, PARENT_ID, PATH, VERSION DESC);
CREATE UNIQUE INDEX JCR_IDX_SITEM_PARENT ON JCR_SITEM(PARENT_ID, CONTAINER_NAME, NAME, I_INDEX, I_CLASS, VERSION DESC);
