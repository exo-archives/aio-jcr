...
CREATE TABLE IF NOT EXISTS JCR_MITEM(
	ID VARCHAR(96) NOT NULL PRIMARY KEY, 
	VERSION INTEGER NOT NULL, 
	PATH VARCHAR(4096) NOT NULL
	);
CREATE UNIQUE INDEX JCR_IDX_MITEM_PATH ON JCR_MITEM(PATH(850), ID, VERSION);
CREATE TABLE JCR_MNODE(
	ID VARCHAR(96) NOT NULL PRIMARY KEY, 
	ORDER_NUM INTEGER, 
	PARENT_ID VARCHAR(96), 
	CONSTRAINT JCR_FK_MNODEPARENT FOREIGN KEY(PARENT_ID) REFERENCES JCR_MNODE(ID), 
...
CREATE TABLE IF NOT EXISTS JCR_MPROPERTY(
	ID VARCHAR(96) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS JCR_MVALUE(
