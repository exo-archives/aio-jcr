...
CREATE UNIQUE INDEX JCR_IDX_MITEM_PATH ON JCR_MITEM(PATH, VERSION);
CREATE UNIQUE INDEX JCR_IDX_MITEM_PARENT ON JCR_MITEM(PARENT_ID, NAME, I_INDEX, I_CLASS, VERSION);

CREATE UNIQUE INDEX JCR_IDX_MITEM_PARENT_PATH ON JCR_MITEM(I_CLASS, PARENT_ID, PATH, VERSION);
...
CREATE INDEX JCR_IDX_MITEM_PARENT_ORD ON JCR_MITEM(I_CLASS, PARENT_ID, N_ORDER_NUM, VERSION);
