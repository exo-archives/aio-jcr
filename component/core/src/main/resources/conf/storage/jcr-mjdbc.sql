...
CREATE UNIQUE INDEX JCR_IDX_MITEM_PATH ON JCR_MITEM(PATH, VERSION DESC);
CREATE UNIQUE INDEX JCR_IDX_MITEM_PARENT_PATH ON JCR_MITEM(I_CLASS, PARENT_ID, PATH, VERSION DESC);
