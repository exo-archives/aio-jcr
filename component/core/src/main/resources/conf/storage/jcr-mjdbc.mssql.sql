...
CREATE UNIQUE INDEX JCR_IDX_MITEM_PATH ON JCR_MITEM(ID, VERSION DESC) INCLUDE (PATH);
...
CREATE UNIQUE INDEX JCR_IDX_MNODE_PARENT ON JCR_MNODE(ID, PARENT_ID, ORDER_NUM);
...
CREATE UNIQUE INDEX JCR_IDX_MPROPERTY_PARENT ON JCR_MPROPERTY(ID, PARENT_ID);
