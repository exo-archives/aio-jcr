...
public class TestRepositoryManagement extends JcrImplBaseTest {
  ...
  public void createDafaultRepository(String repoName, String defaultWs) throws Exception {
    ...
    WorkspaceEntry workspaceEntry = helper.getNewWs(defaultWs,
                                                    isDefaultWsMultiDb,
                                                    null,
  ...
  public void testAddNewRepositoryWithSameName() throws Exception {
    ...
    WorkspaceEntry workspaceEntry = helper.getNewWs("ws4testAddNewRepositoryWithSameName",
                                                    isDefaultWsMultiDb,
                                                    null,
                                                    "target/temp/values/" + IdGenerator.generate(),
                                                    wsEntry.getContainer());
  ...
  public void testCanRemove() throws Exception {
    ...
    WorkspaceEntry workspaceEntry = helper.getNewWs("ws4testCanRemove",
                                                    isDefaultWsMultiDb,
                                                    null,
                                                    "target/temp/values/" + IdGenerator.generate(),
                                                    wsEntry.getContainer());
  ...
  public void testRemove() throws Exception {
    ...
    WorkspaceEntry workspaceEntry = helper.getNewWs("ws4testRemove",
                                                    isDefaultWsMultiDb,
                                                    null,
                                                    "target/temp/values/" + IdGenerator.generate(),
                                                    wsEntry.getContainer());
  ...
  public void testRemoveOtherThread() throws Exception {
    ...
    WorkspaceEntry workspaceEntry = helper.getNewWs("ws4RemoveOtherThread",
                                                    isDefaultWsMultiDb,
                                                    null,
                                                    "target/temp/values/" + IdGenerator.generate(),
                                                    wsEntry.getContainer());
