...
public class TestJCRPath extends TestCase {
  ...
  public void testCreatePath() throws Exception {
    ...
    assertEquals("/jcr:node/node1[2]/exo:node2", factory.createJCRPath(parent, "exo:node2")
                                                        .getAsString(false));
    assertEquals("/jcr:node/node1[2]/exo:node2/node3", factory.createJCRPath(parent,
                                                                             "exo:node2/node3")
                                                              .getAsString(false));
