 ...
 * @version $Id: WorkspaceStorageCacheBaseCase.java 16093 2008-06-20 09:42:29Z pnedonosko $
 */
public abstract class WorkspaceStorageCacheBaseCase extends JcrImplBaseTest {
  ...
  public void testRemoveChildProperties() throws Exception {
    ...
    assertNull("Node " + nodeData2.getQPath().getAsString() + " properties in the cache", cache.getChildProperties(nodeData2));    
  }
  ...
  public void testRemoveChilds() throws Exception {
    ...
    assertNull("Node " + nodeData2.getQPath().getAsString() + " child nodes in the cache", cache.getChildNodes(nodeData2));
