...
public abstract class WorkspaceStorageCacheBaseCase extends JcrImplBaseTest {
  ...
  private QPath                 nodePath1       = QPath.makeChildPath(Constants.ROOT_PATH,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 1"));

  private QPath                 nodePath2       = QPath.makeChildPath(Constants.ROOT_PATH,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 2"));

  private QPath                 nodePath21      = QPath.makeChildPath(nodePath2,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 2.1"));

  private QPath                 nodePath22      = QPath.makeChildPath(nodePath2,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 2.2"));

  private QPath                 nodePath3       = QPath.makeChildPath(Constants.ROOT_PATH,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 3"));

  private QPath                 nodePath31      = QPath.makeChildPath(nodePath3,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 3.1"));

  private QPath                 nodePath32      = QPath.makeChildPath(nodePath3,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "node 3.2"));

  private QPath                 propertyPath11  = QPath.makeChildPath(nodePath1,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "property 1.1"));

  private QPath                 propertyPath12  = QPath.makeChildPath(nodePath1,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "property 1.2"));

  private QPath                 propertyPath21  = QPath.makeChildPath(nodePath2,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "property 2.1"));

  private QPath                 propertyPath22  = QPath.makeChildPath(nodePath2,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "property 2.2"));

  private QPath                 propertyPath311 = QPath.makeChildPath(nodePath31,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "property 3.1.1"));

  private QPath                 propertyPath312 = QPath.makeChildPath(nodePath31,
                                                                      new InternalQName(Constants.NS_EXO_PREFIX,
                                                                                        "property 3.1.2"));
  ...
  public void setUp() throws Exception {
    ...
    WorkspaceStorageCache cacheProbe = (WorkspaceStorageCache) session.getContainer()
  ...
  private void initNodesData() throws RepositoryException {
    ...
    nodeData1 = new PersistedNodeData(nodeUuid1,
                                      nodePath1,
                                      rootUuid,
                                      1,
                                      0,
    ...
    nodeData2 = new PersistedNodeData(nodeUuid2,
                                      nodePath2,
                                      rootUuid,
                                      1,
                                      1,
                                      ...
                                      null,
                                      acl);
    nodeData21 = new PersistedNodeData(nodeUuid21,
                                       nodePath21,
                                       nodeUuid2,
                                       1,
                                       0,
                                       ...
                                       null,
                                       acl);
    nodeData22 = new PersistedNodeData(nodeUuid22,
                                       nodePath22,
                                       nodeUuid2,
                                       1,
                                       1,
    ...
    nodeData3 = new PersistedNodeData(nodeUuid3,
                                      nodePath3,
                                      rootUuid,
                                      1,
                                      2,
                                      ...
                                      null,
                                      acl);
    nodeData31 = new PersistedNodeData(nodeUuid31,
                                       nodePath31,
                                       nodeUuid3,
                                       1,
                                       0,
                                       ...
                                       null,
                                       acl);
    nodeData32 = new PersistedNodeData(nodeUuid32,
                                       nodePath32,
                                       nodeUuid3,
                                       1,
                                       1,
  ...
  private void initDataAsPersisted() {
    propertyData11 = new PersistedPropertyData(propertyUuid11,
                                               propertyPath11,
                                               nodeUuid1,
                                               1,
                                               PropertyType.STRING,
    ...
    propertyData12 = new PersistedPropertyData(propertyUuid12,
                                               propertyPath12,
                                               nodeUuid1,
                                               1,
                                               PropertyType.BINARY,
    ...
    propertyData21 = new PersistedPropertyData(propertyUuid21,
                                               propertyPath21,
                                               nodeUuid2,
                                               1,
                                               PropertyType.STRING,
    ...
    propertyData22 = new PersistedPropertyData(propertyUuid22,
                                               propertyPath22,
                                               nodeUuid2,
                                               1,
    ...
    propertyData311 = new PersistedPropertyData(propertyUuid311,
                                                propertyPath311,
                                                nodeUuid31,
                                                1,
                                                PropertyType.LONG,
    ...
    propertyData312 = new PersistedPropertyData(propertyUuid312,
                                                propertyPath312,
                                                nodeUuid31,
                                                1,
  ...
  public void testGetItem_Persisted() throws Exception {
    ...
    assertEquals("Cached node " + nodeData1.getQPath().getAsString() + " is not equals",
                 cache.get(rootUuid, nodePath1.getEntries()[nodePath1.getEntries().length - 1]),
                 nodeData1);
    assertEquals("Cached node " + nodeData2.getQPath().getAsString() + " is not equals",
                 cache.get(rootUuid, nodePath2.getEntries()[nodePath2.getEntries().length - 1]),
                 nodeData2);

    assertEquals("Cached node " + nodeData1.getIdentifier() + " is not equals",
                 cache.get(nodeUuid1),
                 nodeData1);
    assertEquals("Cached node " + nodeData2.getIdentifier() + " is not equals",
                 cache.get(nodeUuid2),
                 nodeData2);
  ...
  public void testGetItems_Persisted() throws Exception {
    ...
    assertEquals("Cached child node " + nodeData31.getQPath().getAsString() + " is not equals",
                 cache.get(nodeUuid3, nodePath31.getEntries()[nodePath31.getEntries().length - 1]),
                 nodeData31);
    assertEquals("Cached child node " + nodeData31.getIdentifier() + " is not equals",
                 cache.get(nodeUuid31),
                 nodeData31);

    assertEquals("Cached child node " + nodeData32.getQPath().getAsString() + " is not equals",
                 cache.get(nodeUuid3, nodePath32.getEntries()[nodePath32.getEntries().length - 1]),
                 nodeData32);
    assertEquals("Cached child node " + nodeData32.getIdentifier() + " is not equals",
                 cache.get(nodeUuid32),
                 nodeData32);

    assertTrue("Cached child node " + nodeData31.getQPath().getAsString()
        + " is not in the childs list", cache.getChildNodes(nodeData3).contains(nodeData31));
    assertTrue("Cached child node " + nodeData32.getQPath().getAsString()
        + " is not in the childs list", cache.getChildNodes(nodeData3).contains(nodeData32));

    assertEquals("Cached child nodes count is wrong", cache.getChildNodes(nodeData3).size(), 2);

    // props
    assertEquals("Cached child property " + propertyData11.getQPath().getAsString()
                     + " is not equals",
                 cache.get(nodeUuid1,
                           propertyPath11.getEntries()[propertyPath11.getEntries().length - 1]),
                 propertyData11);
    assertEquals("Cached child property " + propertyData11.getIdentifier() + " is not equals",
                 cache.get(propertyUuid11),
                 propertyData11);
    assertEquals("Cached child property " + propertyData12.getQPath().getAsString()
                     + " is not equals",
                 cache.get(nodeUuid1,
                           propertyPath12.getEntries()[propertyPath12.getEntries().length - 1]),
                 propertyData12);
    assertEquals("Cached child property " + propertyData12.getIdentifier() + " is not equals",
                 cache.get(propertyUuid12),
                 propertyData12);

    assertEquals("Cached child property " + propertyData21.getQPath().getAsString()
                     + " is not equals",
                 cache.get(nodeUuid2,
                           propertyPath21.getEntries()[propertyPath21.getEntries().length - 1]),
                 propertyData21);
    assertEquals("Cached child property " + propertyData21.getIdentifier() + " is not equals",
                 cache.get(propertyUuid21),
                 propertyData21);
    assertEquals("Cached child property " + propertyData22.getQPath().getAsString()
                     + " is not equals",
                 cache.get(nodeUuid2,
                           propertyPath22.getEntries()[propertyPath22.getEntries().length - 1]),
                 propertyData22);
    assertEquals("Cached child property " + propertyData22.getIdentifier() + " is not equals",
                 cache.get(propertyUuid22),
                 propertyData22);

    assertTrue("Cached child property " + propertyData11.getQPath().getAsString()
        + " is not in the childs list", cache.getChildProperties(nodeData1)
                                             .contains(propertyData11));
    assertTrue("Cached child property " + propertyData12.getQPath().getAsString()
        + " is not in the childs list", cache.getChildProperties(nodeData1)
                                             .contains(propertyData12));
    assertTrue("Cached child property " + propertyData21.getQPath().getAsString()
        + " is not in the childs list", cache.getChildProperties(nodeData2)
                                             .contains(propertyData21));
    assertTrue("Cached child property " + propertyData22.getQPath().getAsString()
        + " is not in the childs list", cache.getChildProperties(nodeData2)
                                             .contains(propertyData22));

    assertEquals("Cached child properties count is wrong", cache.getChildProperties(nodeData1)
                                                                .size(), 2);
    assertEquals("Cached child properties count is wrong", cache.getChildProperties(nodeData2)
                                                                .size(), 2);
  }
  ...
  public void testGetProperty_Persisted() throws Exception {
    ...
    // here
    assertFalse("Cached child property " + propertyData12.getQPath().getAsString()
        + " is not in the childs list", cache.getChildProperties(nodeData1)
                                             .contains(propertyData12));
  ...
  public void testRemoveChildNodes() throws Exception {
    ...
    assertNull("Node " + nodeData3.getQPath().getAsString() + " childs in the cache",
               cache.getChildNodes(nodeData3));
  }
  ...
  public void testRemoveChildProperties() throws Exception {
    ...
    assertNull("Node " + nodeData2.getQPath().getAsString() + " properties in the cache",
               cache.getChildProperties(nodeData2));
  }
  ...
  public void testRemoveChilds() throws Exception {
    ...
    assertNull("Node " + nodeData2.getQPath().getAsString() + " child nodes in the cache",
               cache.getChildNodes(nodeData2));
    assertNull("Node " + nodeData21.getQPath().getAsString() + " in the cache",
               cache.get(nodeUuid21));
    assertNull("Node " + nodeData22.getQPath().getAsString() + " in the cache",
               cache.get(nodeUuid22));

    assertNull("Node " + nodeData2.getQPath().getAsString() + " properties in the cache",
               cache.getChildProperties(nodeData2));
    assertNull("Property " + propertyData21.getQPath().getAsString() + " in the cache",
               cache.get(propertyUuid21));
    assertNull("Property " + propertyData22.getQPath().getAsString() + " in the cache",
               cache.get(propertyUuid22));
  }
}
