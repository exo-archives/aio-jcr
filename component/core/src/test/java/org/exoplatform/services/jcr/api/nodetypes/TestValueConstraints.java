...
public class TestValueConstraints extends JcrAPIBaseTest {
  ...
  public void testSTRING1Property() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testSTRING1", "abc");
	root.save();
	try {
  ...
  public void testSTRING2Property() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testSTRING2", "abc");
	testProperty.setValue("abcd");
  ...
  public void testPATHProperty() throws Exception {
	...
	//testProperty.setValue(valueFactory.createValue("/exojcrtest/ghi", PropertyType.PATH));
  ...
  public void testNAMEProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testNAME", valueFactory.createValue("abc:"));
  ...
  public void testREFERENCEProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testREFERENCE", refNodeNtUnstructured);
	root.save();
	try {
  ...
  public void testBINARYINCLUSIVEProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testBINARYINCLUSIVE", new FileInputStream(LOCAL_SMALL_FILE));
  ...
  public void testBINARYEXCLUSIVEProperty() throws Exception {
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
	      setProperty("jcr:testBINARYEXCLUSIVE", new FileInputStream(LOCAL_NORMAL_FILE));
	  root.save();
	  fail("setValue(BINARY value) must throw a ConstraintViolationException ");
    }catch (Exception e) {
	 //succes 	
  ...
  public void testDATEINCLUSIVEProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testDATEINCLUSIVE", valueFactory.createValue("1111-11-11T11:11:11.111Z",PropertyType.DATE));
  ...
  public void testDATEEXCLUSIVEProperty() throws Exception {
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
		  setProperty("jcr:testDATEEXCLUSIVE", valueFactory.createValue("1111-11-11T11:11:11.111Z",PropertyType.DATE));
	  testProperty.setValue(valueFactory.createValue("1222-11-11T11:11:11.111Z", PropertyType.DATE));
	  root.save();
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
	  	  setProperty("jcr:testDATEEXCLUSIVE", valueFactory.createValue("1155-11-11T11:11:11.111Z",PropertyType.DATE));
	  root.save();
	  fail("setValue(DATE value) must throw a ConstraintViolationException ");
	}catch (Exception e) {
	 //succes 	
  ...
  public void testLONGINCLUSIVEProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testLONGINCLUSIVE", 100);
  ...
  public void testLONGEXCLUSIVEProperty() throws Exception {
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
		  setProperty("jcr:testLONGEXCLUSIVE", 100);
	  testProperty.setValue(200);
	  root.save();
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
	  	  setProperty("jcr:testLONGEXCLUSIVE", 150);
	  root.save();
	  fail("setValue(LONG value) must throw a ConstraintViolationException ");
	}catch (Exception e) {
	 //succes 	
  ...
  public void testDOUBLEINCLUSIVEProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testDOUBLEINCLUSIVE", 100);
	testProperty.setValue(200);
	root.save();
  }
  ...
  public void testDOUBLEEXCLUSIVEProperty() throws Exception {
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
		  setProperty("jcr:testDOUBLEEXCLUSIVE", 100);
	  testProperty.setValue(200);
	  root.save();
	...
	try {  
	  Property testProperty = testValueConstraintsNode.
	  	  setProperty("jcr:testDOUBLEEXCLUSIVE", 150);
	  root.save();
	  fail("setValue(DOUBLE value) must throw a ConstraintViolationException ");
	}catch (Exception e) {
	 //succes 	
  ...
  public void testBOOLEANProperty() throws Exception {
	...
	Property testProperty = testValueConstraintsNode.
		setProperty("jcr:testBOOLEAN", true);
	root.save();
	try {
