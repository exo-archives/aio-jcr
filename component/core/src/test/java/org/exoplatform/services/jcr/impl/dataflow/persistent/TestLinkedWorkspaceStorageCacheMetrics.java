 ...
 * @version $Id: TestLinkedWorkspaceStorageCacheMetrics.java 16571 2008-06-27 12:10:27Z pnedonosko $
 */
public class TestLinkedWorkspaceStorageCacheMetrics extends JcrImplBaseTest {
  ...
  public void testLiveTime() throws Exception {
    ...
    WorkspaceStorageCache cache = new LinkedWorkspaceStorageCacheImpl("testLiveTime_cache", true, cacheSize, liveTime, 60 * 1000, 20 * 1000, false, true, 0, true);
  ...
  public void testExpiredScheduler() throws Exception {
    ...
    WorkspaceStorageCache cache = new LinkedWorkspaceStorageCacheImpl("testExpiredScheduler_cache", true, cacheSize, liveTime, liveTime * 1000 + 10000, 10 * 1000, false, true, 0, true); // (*)
  ...
  public void testSize() throws Exception {
    final int cacheSize = 500; 
    WorkspaceStorageCache cache = new LinkedWorkspaceStorageCacheImpl("testSize_cache", true, cacheSize, 120, 60 * 1000, 20 * 1000, false, true, 0, true);
