...
public class TestVersionHistory extends BaseVersionTest {
  ...
  public void testVersionHistoryTree() throws Exception {
    ...
    //
    checkItemsExisted(new String[] { n1.getPath(), snsN1_2.getPath(), snsN1_3.getPath(),
        n2.getPath(), snsN2_2_Other.getPath(), n3.getPath() }, new String[] { n4.getPath(),
  ...
  public void testVersionRemove() throws Exception {
    ...
    checkItemsExisted(new String[] { "/testRoot/testVersionable/n1",
        ...
        "/testRoot/testVersionable/n5" }, new String[] { "/testRoot/testVersionable/n2",
        "/testRoot/testVersionable/n4" });
    showVersionable(testVersionable);
    checkVersionHistory(testVersionable, 3);
