...
public class TestVersionHistory extends BaseVersionTest {
  ...
  public void testVersionRemove() throws Exception {
    ...
    checkItemsExisted(new String[] {"/testRoot/testVersionable/n1", "/testRoot/testVersionable/n1[2]", 
        "/testRoot/testVersionable/n1[3]", "/testRoot/testVersionable/n1[4]",
        "/testRoot/testVersionable/n2", "/testRoot/testVersionable/n3", "/testRoot/testVersionable/n4", 
        "/testRoot/testVersionable/n5"}, null);
    showVersionable(testVersionable);
    checkVersionHistory(testVersionable, 4);
    ...
    checkItemsExisted(new String[] {"/testRoot/testVersionable/n1", "/testRoot/testVersionable/n1[2]", 
        "/testRoot/testVersionable/n1[3]", "/testRoot/testVersionable/n1[4]",
        "/testRoot/testVersionable/n3", "/testRoot/testVersionable/n5"},
        new String[] {"/testRoot/testVersionable/n2", "/testRoot/testVersionable/n4"});
    showVersionable(testVersionable);
    checkVersionHistory(testVersionable, 3);
    ...
    checkItemsExisted(new String[] {"/testRoot/testVersionable/n1", "/testRoot/testVersionable/n1[2]", 
        "/testRoot/testVersionable/n1[3]", "/testRoot/testVersionable/n1[4]",
        "/testRoot/testVersionable/n3", "/testRoot/testVersionable/n4"},
        new String[] {"/testRoot/testVersionable/n5"});
    showVersionable(testVersionable);
    checkVersionHistory(testVersionable, 3);
