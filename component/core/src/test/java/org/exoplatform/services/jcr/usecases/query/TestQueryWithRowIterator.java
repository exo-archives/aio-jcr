...
/**
 * Created by The eXo Platform SARL Author : Nhu Dinh Thuan nhudinhthuan@exoplatform.com Nov 14,
 * 2008
 */
public class TestQueryWithRowIterator extends BaseUsecasesTest {
  ...
  public void testExcerpt() throws Exception {
    ...
    Query q1 = queryManager.createQuery("select * from nt:base where jcr:path like '/" + name + "'",
                                        Query.SQL);
