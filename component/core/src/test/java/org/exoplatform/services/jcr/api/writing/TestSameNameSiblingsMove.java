...
public class TestSameNameSiblingsMove extends JcrAPIBaseTest {
  ...
  /**
   * Move SNS node to different location with SNS too, move /snsMoveTest/node1/node[2] to
   * /snsMoveTest/node2/node[3].
   * 
   * @throws LoginException
   * @throws NoSuchWorkspaceException
   * @throws RepositoryException
   */
  public void testMoveToDiffLocation() throws LoginException,
