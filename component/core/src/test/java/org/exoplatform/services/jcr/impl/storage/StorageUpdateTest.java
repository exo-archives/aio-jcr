...
public class StorageUpdateTest extends JcrImplBaseTest {
  ...
  public void setUp() throws Exception {
    ...
    log.info("node_R node uuid: " + node_R.getUUID() + ", jcr:uuid: "
        + node_R.getProperty("jcr:uuid").getString());
    ...
    log.info("node_V node uuid: " + node_V.getUUID() + ", jcr:uuid: "
        + node_V.getProperty("jcr:uuid").getString());
