...
public class TestItemDataChangesLog extends JcrImplBaseTest {
  ...
  public void setUp() throws Exception {
    super.setUp();
    QPath path1 = QPath.makeChildPath(Constants.ROOT_PATH,
                                      new InternalQName(null, "testBasicOperations1"));
    QPath path2 = QPath.makeChildPath(Constants.ROOT_PATH,
                                      new InternalQName(null, "testBasicOperations2"));
    QPath path3 = QPath.makeChildPath(Constants.ROOT_PATH,
                                      new InternalQName(null, "testBasicOperations3"));

    data1 = new TransientNodeData(path1,
                                  "1",
                                  0,
    ...
    data2 = new TransientNodeData(path2,
                                  "2",
                                  0,
                                  new InternalQName(Constants.NS_NT_URI, "unstructured"),
                                  new InternalQName[0],
                                  ...
                                  Constants.ROOT_UUID,
                                  new AccessControlList());
    data3 = new TransientPropertyData(path3,
                                      "3",
                                      0,
                                      PropertyType.STRING,
                                      Constants.ROOT_UUID,
  ...
  public void testSessionOperations() throws Exception {
    ...
    TransientNodeData d1 = TransientNodeData.createNodeData(data1,
