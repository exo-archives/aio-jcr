...
public class JDBCWDCTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    //    
    container = new JDBCWorkspaceDataContainer(config,
                                               repositoryEntry,
                                               null,
  ...
  public void testCreateDB() throws Exception {
    String script = "CREATE TABLE JCR_MITEM(ID VARCHAR(255) NOT NULL PRIMARY KEY,VERSION INTEGER NOT NULL,PATH VARCHAR(255) NOT NULL);"
  ...
  public void _testAddRoot() throws Exception {
    ...
    TransientPropertyData ntProp = new TransientPropertyData(QPath.makeChildPath(rootPath,
