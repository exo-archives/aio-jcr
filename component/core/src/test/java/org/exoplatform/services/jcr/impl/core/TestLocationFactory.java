...
public class TestLocationFactory extends TestCase {
  ...
  private static String         testJCRPathElementValid[][] = { { "jcr:name", "jcr", "name" },
      { "jcr:name[30]", "jcr", "name" }, { "na me[1]", "", "na me" }, { "...", "", "..." },
      { "123", "", "123" }                                 };
  ...
  public void testCreateLongJCRPath() throws RepositoryException {
    for (int i = 1; i <= MAX_CREATE_PATH_TIME; i++) {
      factory.parseAbsPath("/jcr:namenamename/jcr:namenamename/jcr:namenamename/jcr:namenamename/jcr:namenamename/jcr:namenamename");
    }
  }
