...
public class TestInvalidItemState extends JcrAPIBaseTest {
  ...
  /**
   * Test if remove of same-name siblings will not thorwn an exception.
   * Nodes are removed by their Ids.
   * 
   ...
   * <p>Check if refresh(true) and refresh(false) works ok with changes recorded on the Session.    
   *  
   * @throws LoginException
   * @throws NoSuchWorkspaceException
   * @throws RepositoryException
