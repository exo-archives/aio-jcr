 ...
 * 09.01.2007
 *
 * We testing a workspace cache with mixin types. 
 * A cache work in shadow, but we try to do usecases of possible wrong cache work.
 *
 * @author <a href="mailto:peter.nedonosko@exoplatform.com.ua">Peter Nedonosko</a>
 * @version $Id: TestCachedMixins.java 16093 2008-06-20 09:42:29Z pnedonosko $
 */
public class TestCachedMixins extends JcrImplBaseTest {
  ...
  public void testMixinAdd() throws Exception {
    ...
    SessionImpl anotherSession = (SessionImpl) repository.login(this.credentials /*session.getCredentials()*/);
