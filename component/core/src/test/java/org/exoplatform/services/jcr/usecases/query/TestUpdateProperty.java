...
public class TestUpdateProperty extends BaseUsecasesTest {
  ...
  public void testAddUpdateRemoveProperty() throws Exception {
    ...
    Query query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value1')",
                                      Query.SQL);
    assertEquals(1, query.execute().getNodes().getSize());

    query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value2')",
                                Query.SQL);
    assertEquals(1, query.execute().getNodes().getSize());
    ...
    query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value1-2')",
                                Query.SQL);
    assertEquals(1, query.execute().getNodes().getSize());

    query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value1')",
                                Query.SQL);
    ...
    query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value3')",
                                Query.SQL);
    assertEquals(1, query.execute().getNodes().getSize());
  ...
  public void testMoveNode() throws Exception {
    ...
    query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value21')",
                                Query.SQL);
    assertEquals(1, query.execute().getNodes().getSize());

    query = manager.createQuery("SELECT * FROM nt:base " + " WHERE CONTAINS(., 'value22')",
                                Query.SQL);
    assertEquals(1, query.execute().getNodes().getSize());
