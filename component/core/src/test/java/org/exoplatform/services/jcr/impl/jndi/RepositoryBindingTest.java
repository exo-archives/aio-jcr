 ...
 * @version $Id: RepositoryBindingTest.java 12841 2007-02-16 08:58:38Z peterit $
 */
public class RepositoryBindingTest extends JcrImplBaseTest {
  ...
  /**
   * Prerequisites: there should be entry in configuration.xml like:
   *       <component-plugin> 
        ...
        <init-params>
          ...
          <properties-param>
            ...
            <!-- property name="containerConfig" value=""/ -->
          </properties-param>     
        </init-params>    
       </component-plugin>
