...
public class TestStringLongComparison extends TestCase {
  ...
  public void testUUIDInMap() throws Exception {
    ...
    System.out.println("Puts done " + getName() + " items:" + RECORDS_COUNT + ", time:" + d
        + "ms, avg.time:" + avg + "ms, " + memoryInfo());
    ...
    System.out.println("Gets done " + getName() + " items:" + select.size() + ", time:" + d
        + "ms, avg.time:" + avg + "ms, " + memoryInfo() + "\n");
  ...
  public void testUUIDInList() throws Exception {
    ...
    long d = (System.currentTimeMillis() - start);
    double avg = Math.round(d * 1000d / RECORDS_COUNT) / 1000d;
    System.out.println("Adds done " + getName() + " items:" + RECORDS_COUNT + ", time:" + d
        + "ms, avg.time:" + avg + "ms, " + memoryInfo());
