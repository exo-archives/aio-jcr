 ...
 * @version $Id: TestStringLongComparison.java 111 2007-11-11 11:11:11Z peterit $
 */
public class TestStringLongComparison extends TestCase {
  ...
  public void testUUIDInList() throws Exception {
    ...
    long d = (System.currentTimeMillis() - start);
    double avg = Math.round(d * 1000d / RECORDS_COUNT)/1000d;
    System.out.println("Adds done " + getName() + " items:" + RECORDS_COUNT + ", time:" + d + "ms, avg.time:" + avg + "ms, " + memoryInfo());
    ...
    d = (System.currentTimeMillis() - start);
    avg = Math.round(d * 1000d / select.size())/1000d;
    System.out.println("Gets done " + getName() + " items:" + select.size() + ", time:" + d + "ms, avg.time:" + avg + "ms, " +
        memoryInfo() + "\n");
  }
  ...
  public void testStringInMap() throws Exception {
    ...
    long d = (System.currentTimeMillis() - start);
    double avg = Math.round(d * 1000d / RECORDS_COUNT)/1000d;
    System.out.println("Puts done " + getName() + " items:" + RECORDS_COUNT + ", time:" + d + "ms, avg.time:" + avg + "ms, " + memoryInfo());
