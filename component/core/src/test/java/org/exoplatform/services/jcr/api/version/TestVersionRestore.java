...
public class TestVersionRestore extends BaseVersionTest {
  ...
  public void testRestore() throws Exception {
    ...
    try {
      ...
      Node doc1 = checkExisted("doc1", new String[] { "jcr:content/jcr:primaryType",
          "jcr:content/doc1ContentProperty" });
      ...
      doc1 = checkExisted("doc1", new String[] { "jcr:content/jcr:primaryType",
          "jcr:content/doc1ContentProperty" });
      Node doc2 = checkExisted("doc2", new String[] { "jcr:content/jcr:primaryType",
          "jcr:content/doc2ContentProperty" });
