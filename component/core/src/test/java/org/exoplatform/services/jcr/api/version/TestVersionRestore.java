...
public class TestVersionRestore extends BaseVersionTest {
  ...
  /**
   * Test if Node.restore(version, relPath, removeExisted) works ok with relPath different from versionable node. 
   * The problem occurs with subnodes of versionable subtree which has OnParentVersion.COPY or VERSION.
   * 
   * @throws Exception
   */
