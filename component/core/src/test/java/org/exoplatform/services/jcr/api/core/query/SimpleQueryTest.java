...
public class SimpleQueryTest extends AbstractQueryTest {
  ...
  public void testSimpleQuerySQL1() throws Exception {
    ...
    String sql = "SELECT * FROM nt:base" + " WHERE jcr:path LIKE '" + testRoot + "/foo'"
        + " AND bla = 'bla'";
  ...
  public void testSimpleQuerySQL2() throws Exception {
    ...
    String sql = "SELECT * FROM nt:file" + " WHERE jcr:path LIKE '" + testRoot + "/%'"
        + " AND bla = 'bla'";
    Query q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    QueryResult result = q.execute();
  ...
  public void testDateField1() throws Exception {
    ...
    String sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot
        + "/%' AND birth > TIMESTAMP '1976-01-01T00:00:00.000+01:00'";
    Query q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    QueryResult result = q.execute();
    checkResult(result, 1);

    sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot
  ...
  public void testLikePatternEscaped() throws Exception {
    ...
    String sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot
        + "/%' AND value LIKE 'foo\\_bar' ESCAPE '\\'"; // matches node3
    Query q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    QueryResult result = q.execute();
    checkResult(result, 1);
    ...
    sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot
        + "/%' AND value LIKE 'foo\\\\\\_bar' ESCAPE '\\'"; // matches node1
    q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    result = q.execute();
    checkResult(result, 1);

    sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot
        + "/%' AND value LIKE 'foo\\_bar'"; // matches node1
    q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    result = q.execute();
    checkResult(result, 1);
  }
  ...
  public void testNotEqual() throws Exception {
    ...
    String jcrql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot
        + "/%' AND value <> 'bar'";
  ...
  public void testGeneralComparison() throws Exception {
    ...
    String sql = "SELECT * FROM nt:unstructured WHERE 'foo' IN text " + "and jcr:path LIKE '"
        + testRoot + "/%'";
    Query q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    QueryResult result = q.execute();
    ...
    sql = "SELECT * FROM nt:unstructured WHERE 'bar' NOT IN text " + "and jcr:path LIKE '"
        + testRoot + "/%'";
    q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    result = q.execute();
    checkResult(result, new Node[] { foo, bar, bla });
    ...
    sql = "SELECT * FROM nt:unstructured WHERE 'foo' NOT IN text " + "and jcr:path LIKE '"
        + testRoot + "/%'";
    q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
    result = q.execute();
