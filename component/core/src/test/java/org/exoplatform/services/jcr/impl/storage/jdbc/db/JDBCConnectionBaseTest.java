...
public class JDBCConnectionBaseTest extends TestCase{
	...
	public void setUp() throws Exception {
		...
		try{
			st.executeUpdate("insert into JCR_SITEM values"+"('12345','123456','Sam',20090525,'myContainer',2,1233,5,10,1)");
			st.executeUpdate("insert into JCR_SITEM values"+"('myContainer123','1235','Nick',20090625,'myContainer',1,1233,5,10,1)");
	...
	public NodeData giveNode() throws Exception{
		InternalQName[] iqn = {InternalQName.parse("[]DbJDBCConnectionEditTest")};
		TransientNodeData tnd = new TransientNodeData(Constants.JCR_NODETYPES_PATH,
													"123",
													2,
													Constants.SV_NODE_NAME,
													iqn,
													7,
													"4512",
													null);
