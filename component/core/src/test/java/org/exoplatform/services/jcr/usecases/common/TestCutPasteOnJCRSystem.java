...
public class TestCutPasteOnJCRSystem extends BaseStandaloneTest {
  ...
  public void testCutActionJcrSystem() throws Exception {
    ...
    Session otherAdminSession = repository.login(new SimpleCredentials("admin",
                                                                       "admin".toCharArray()),
                                                 workspaceName);
    ...
    String destPath2Paste = sportsTaxonomy.getPath()
  ...
  private void initTaxonomyTree() throws Exception {
    ...
    adminSession_ = repository.login(new SimpleCredentials("admin", "admin".toCharArray()),
                                     systemWorkspaceName_);
    ...
    taxonomyHome = systemSession_.getRootNode().addNode("jcr:system/exo:taxonomies",
                                                        "nt:unstructured");
    systemSession_.save();
