...
public class TestNodeReferenceAmongSessions extends BaseUsecasesTest {
  ...
  public void testNodeReferenceAmongSessions() throws Exception {
    ...
    Session session4 = repository.login(new SimpleCredentials("admin", "admin".toCharArray()),
                                        wss[1]);
    ...
    Session refSession1 = repository.login(new SimpleCredentials("admin", "admin".toCharArray()),
                                           wss[0]);
    ...
    Session refSession2 = repository.login(new SimpleCredentials("admin", "admin".toCharArray()),
                                           wss[1]);
