...
public class CmdMode extends FtpCommandImpl {
  ...
  public void run(String[] params) throws IOException {
    ...
    if ("C".equals(params[1].toUpperCase()) || "B".equals(params[1].toUpperCase())) {
      reply(String.format(FtpConst.Replyes.REPLY_504, FtpConst.Commands.CMD_MODE + " "
          + params[1].toUpperCase()));
      return;
    }

    reply(String.format(FtpConst.Replyes.REPLY_501_MODE, FtpConst.Commands.CMD_MODE + " "
        + params[1].toUpperCase()));
  }
