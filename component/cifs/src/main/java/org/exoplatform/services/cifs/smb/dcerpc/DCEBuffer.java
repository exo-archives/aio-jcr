...
public class DCEBuffer {
	...
	private final static int[] _alignMask = { 0xFFFFFFFE, 0xFFFFFFFC,
			0xFFFFFFF8 };
	...
	public final String getUnicodeString() throws DCEBufferException {
		...
		String str = DataPacker.getUnicodeString(m_buffer, m_rdpos,
				MAX_STRING_LEN);
		if (str != null)
	...
	public final void putUnicodeHeader(String str, boolean incNul) {
		...
		DataPacker.putIntelInt(str != null ? DUMMY_ADDRESS : 0, m_buffer,
				m_pos + 4);
	...
	public final void putUnicodeHeader(int len) {
		...
		DataPacker.putIntelInt(sLen != 0 ? DUMMY_ADDRESS : 0, m_buffer,
				m_pos + 4);
