 ...
 * <p>
 * The SMBStatus class contains the error class and error code values that a
 * remote server may return.
 * <p>
...
public final class SMBStatus {
  ...
  public static final int ERRBadPath = 2;
  public static final int ERRBadFile = 3;
