 ...
 * Class extended by SMBServer and probably NetBIOSNameServer
 */
public abstract class NetworkServer
{
    private static final Log logger = ExoLogger.getLogger("org.exoplatform.services.CIFS.server");
    ...
    /**
     *  Shared devices which server consists
     *  opened sessions has own dynamic shares
     */ 
	 ...
	 * @exception Exception
	 */
    public final SharedDevice findShare(String name, int typ, SrvSession sess, boolean create)
            throws Exception
    {
