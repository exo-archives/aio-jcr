...
public final class SMBDate extends Date {
	...
	// Constants
	//
	// Bit masks for extracting the date/time fields from an SMB encoded
	// date/time.
	//
	 ...
	 * 
	 * @param secs
	 *            Seconds since base date/time 1970 value
	 */
	 ...
	 * 
	 * @param dat
	 *            SMB encoded date value
	 * @param tim
	 *            SMB encoded time value
	 */
  ...
  /**
   * Create a new SMBDate using a Colendar object
   * @param c Calendar
   */
  public SMBDate(Calendar c){
