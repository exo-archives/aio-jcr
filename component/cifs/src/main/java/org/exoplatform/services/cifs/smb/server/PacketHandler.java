...
public abstract class PacketHandler {
	 ...
	 */
	public PacketHandler(Socket sock, int typ, String name, String shortName)
			throws IOException {
		m_socket = sock;
		m_protoType = typ;
		m_protoName = name;
	 ...
	 *                If a network error occurs.
	 */
	public final int readPacket(byte[] pkt, int off, int len)
			throws IOException {
	 ...
	 *                If a network error occurs.
	 */
	public final void writePacket(byte[] pkt, int off, int len)
			throws IOException {
