...
import org.exoplatform.services.cifs.util.*;
...
public class ServerType {
	...
	private static final String[] _srvType = { "Workstation", "Server",
			"SQLServer", "DomainController", "BackupDomainController",
			"TimeSource", "AFPServer", "NovellServer", "DomainMember",
			"PrintServer", "DialinServer", "UnixServer", "NTServer",
			"WfwServer", "MFPNServer", "NtNonDCServer", "PotentialBrowse",
			"BackupBrowser", "MasterBrowser", "DomainMaster", "OSFServer",
			"VMSServer", "Win95Plus", "DFSRoot", "NTCluster", "TerminalServer",
			"", "", "DCEServer" };
