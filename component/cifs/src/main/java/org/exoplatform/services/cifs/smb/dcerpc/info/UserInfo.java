 ...
 * License.
 */
package org.exoplatform.services.cifs.smb.dcerpc.info;
...
import org.exoplatform.services.cifs.smb.dcerpc.DCEReadable;
...
public class UserInfo implements DCEReadable {
	...
	/**
	 * Return the date/time the account expires, or NTTime.Infinity if it does
	 * not expire
	 * 
	 * @return long
	 */
	...
	public void readStrings(DCEBuffer buf) throws DCEBufferException {
		...
		case InfoLevel1:
			m_userName = buf.getCharArrayNotNull(m_userName,
					DCEBuffer.ALIGN_INT);
			m_fullName = buf.getCharArrayNotNull(m_fullName,
					DCEBuffer.ALIGN_INT);

			m_description = buf.getCharArrayNotNull(m_description,
					DCEBuffer.ALIGN_INT);
		...
		case InfoLevel3:
			...
			m_homeDirDrive = buf.getCharArrayNotNull(m_homeDirDrive,
					DCEBuffer.ALIGN_INT);

			m_scriptPath = buf.getCharArrayNotNull(m_scriptPath,
					DCEBuffer.ALIGN_INT);
			m_profile = buf.getCharArrayNotNull(m_profile, DCEBuffer.ALIGN_INT);
			m_workStations = buf.getCharArrayNotNull(m_workStations,
					DCEBuffer.ALIGN_INT);
		...
		case InfoLevel21:
			...
			m_workStations = buf.getCharArrayNotNull(m_workStations,
					DCEBuffer.ALIGN_INT);
			m_accComment = buf.getCharArrayNotNull(m_profile,
					DCEBuffer.ALIGN_INT);

			m_callBack = buf.getCharArrayNotNull(m_callBack,
					DCEBuffer.ALIGN_INT);
			m_unknown1 = buf.getCharArrayNotNull(m_unknown1,
					DCEBuffer.ALIGN_INT);
			m_unknown2 = buf.getCharArrayNotNull(m_unknown2,
					DCEBuffer.ALIGN_INT);
			m_unknown3 = buf.getCharArrayNotNull(m_unknown3,
					DCEBuffer.ALIGN_INT);
