...
public class NetBIOSName {
  ...
  public final void setName(String name) {
    ...
    // Check if the name contains a name scope, if so then split the name and
    // scope id
  ...
  public byte[] encodeName() {
    ...
    // Check if there is a NetBIOS name scope to be appended to the encoded name
    // string
