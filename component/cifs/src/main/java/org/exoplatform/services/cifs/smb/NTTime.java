...
public class NTTime {
	...
	// Time conversion constant, difference between NT 64bit base date of
	// 1-1-1601 00:00:00 and
	...
	public final static long toNTTime(Date jdate) {
		...
		// Add the conversion constant to the Java date raw value, convert the
		// Java milliseconds to
		// 100ns units
