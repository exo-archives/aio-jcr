...
public abstract class NetworkFile {
  ...
  abstract public int writeFile(byte[] buf, int dataPos, int dataLen, int offset) throws Exception;

  //abstract public int readFile(byte[] buf, int maxCount, int dataPos, int offset)throws Exception;
