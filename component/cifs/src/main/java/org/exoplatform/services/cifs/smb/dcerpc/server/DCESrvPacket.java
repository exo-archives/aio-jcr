...
import org.exoplatform.services.cifs.smb.dcerpc.DCECommand;
import org.exoplatform.services.cifs.smb.dcerpc.DCEDataPacker;
...
public class DCESrvPacket extends SMBTransPacket {
  ...
  /**
   * Initialize the DCE/RPC request. Set the SMB transaction parameter count so
   ...
   *          int
   */
  public final void initializeDCERequest(int handle, byte typ, int flags,
      int callId) {
  ...
  public final void DumpHeader() {
    ...
    System.out
        .println("  Packed Data Rep : 0x" + getPackedDataRepresentation());
