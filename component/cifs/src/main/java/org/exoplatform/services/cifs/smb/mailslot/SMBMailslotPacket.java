...
public class SMBMailslotPacket {
   ...
   * must be called after the parameter count and parameter block length have
   * been set.
   * 
  ...
  /**
   * Return the parameter block offset where the parameter bytes should be
   * placed. This method must be called after the paramter count has been set.
   * The parameter offset is word aligned.
   * 
   ...
   *          Transaction name
   * @param pcnt
   *          Total parameter count for this transaction
   * @param paramblk
   *          Parameter block data bytes
   * @param plen
   *          Parameter block data length
   * @param datablk
   *          Data block data bytes
   * @param dlen
   *          Data block data length
   */
  protected final void initializeTransact(String name, int pcnt,
