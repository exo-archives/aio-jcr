...
public abstract class DCEList
{
    ...
    protected DCEList(DCEBuffer buf) throws DCEBufferException
    {
        ...
        // Read the header from the DCE/RPC buffer that contains the information
		// level and container
        // pointer
    ...
    public final void writeList(DCEBuffer buf) throws DCEBufferException
    {
        ...
        if (m_dceObjects != null)
        {
            ...
            // Create a seperate DCE buffer to build the string list which may
			// follow the main
            ...
            for (int i = 0; i < m_dceObjects.size(); i++)
            {
                ...
                // Write the object to the buffer, strings may go into the
				// seperate string buffer
