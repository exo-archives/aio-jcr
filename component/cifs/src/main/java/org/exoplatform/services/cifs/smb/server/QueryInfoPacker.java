...
public class QueryInfoPacker {
	...
	/**
	 * Pack a file information object into the specified buffer, using the
	 ...
	 */
	private static void packInfoStandard(FileInfo info, DataBuffer buf,
	 ...
	 *            Pack unicode strings
	 */
	private static void packNameFileInfo(FileInfo info, DataBuffer buf,
			boolean uni) {
	 ...
	 *            Pack unicode strings
	 */
	private static void packAllFileInfo(FileInfo info, DataBuffer buf,
			boolean uni) {
	 ...
	 *            Pack unicode strings
	 */
	private static void packStreamFileInfo(FileInfo info, DataBuffer buf,
			boolean uni) {
	 ...
	 * @return int
	 */
	/*public static int packStreamFileInfo(StreamInfoList streams,
		...
		for (int i = 0; i < streams.numberOfStreams(); i++) {
			...
			if (i < (streams.numberOfStreams() - 1)) {
				...
				// Fill in the offset from the current stream information
