...
public class TransactBuffer {
	 ...
	 *            int
	 */
	public TransactBuffer(int func, int scnt, int pcnt, byte[] dbuf, int doff,
			int dlen) {
	...
	/**
	 * Return the transaction type (from SBMSrvPacketType, either Transaction,
	 * Transaction2 or NTTransact)
	 * 
	 * @return int
	 */
	...
	/**
	 * Set the end of buffer positions for the setup, parameter and data buffers
