...
public class NTTransPacket extends SMBSrvPacket {
  ...
  private static final int ParameterBytes = 36; // 8 x 32bit params + max setup
                                                // count byte +
   ...
   */
  public final void initTransact(int func, byte[] paramblk, int plen,
      byte[] datablk, int dlen, int setupcnt) {
    initTransact(func, paramblk, plen, datablk, dlen, setupcnt,
        DefaultReturnParams, DefaultReturnData);
  }
   ...
   */
  public final void initTransact(int func, byte[] paramblk, int plen,
      byte[] datablk, int dlen, int setupcnt, int maxPrm, int maxData) {
   ...
   *          Data block data length
   */
  public final void initTransactReply(byte[] paramblk, int plen,
      byte[] datablk, int dlen) {
   ...
   * 
   * @param cnt
   *          Maximum count of setup paramater words
   */
   ...
   * 
   * @param cnt
   *          Count of setup paramater words
   */
  ...
  /**
   * Reset the byte/parameter pointer area for packing/unpacking the transaction
   * data block
   */
