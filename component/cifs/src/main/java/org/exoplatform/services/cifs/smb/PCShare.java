...
public final class PCShare {
   ...
   *          \\node\\share.
   * @exception InvalidUNCPathException
   ...
   * @param uname
   *          User name used to access the remote share.
   * @param pwd
   *          Password used to access the remote share.
   */
  ...
  /**
   * Build a share relative path using the supplied working directory and file
   * name.
   * 
   * @param workdir
   *          Working directory string, relative to the root of the share.
   * @param fname
   *          File name string.
   ...
   * 
   * @return Path string of the remote share/path/file relative to the share,
   *         ie. \path\file.
   */
  ...
  public final void setNetworkPath(String netpath)
    ...
    if (endpos == -1) {
      ...
      if (endpos != -1 && endpos > pos) {
        ...
        // Set the share relative path, and update the current position
        // index
   ...
   * 
   * @param pwd
   *          Remote password string, required to access the remote share.
   */
  ...
  /**
   * Set the primary and secondary protocol order that is used to connect to the
   * remote host.
   * 
   * @param pri
   *          int
