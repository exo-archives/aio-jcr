 ...
 * <p>
 * Defines various bit masks that may be returned in an FileInfo object, that is
 * returned by the DiskInterface.getFileInformation () and
 * SearchContext.nextFileInfo() methods.
 * <p>
 * The values are also used by the DiskInterface.StartSearch () method to
 * determine the file/directory types that are returned.
 * 
 * @see DiskInterface
 * @see SearchContext
 */
public final class FileAttribute {
	...
	/**
	 * Determine if the specified file attribute mask has the specified file
	 * attribute enabled.
	 * 
	 * @return boolean
	 * @param attr
  ...
  public static final String toString(int attr){
    StringBuilder sb = new StringBuilder();
    sb.append("[");
    sb.append((isSystem(attr))?"System":"notSystem");
    sb.append("|");
    sb.append((isArchived(attr))?"Archived":"notArchived");
    sb.append("|");
    sb.append((isReadOnly(attr))?"ReadOnly":"notReadOnly");
    sb.append("|");
    sb.append((isDirectory(attr))?"Directory":"notDirectory");
    sb.append("|");
    sb.append((isHidden(attr))?"Hidden":"notHidden");
    sb.append("]");
