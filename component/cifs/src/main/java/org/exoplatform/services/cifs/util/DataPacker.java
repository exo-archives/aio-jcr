...
public final class DataPacker {
	 ...
	 * @return String, else null if the terminating null character was not
	 *         found.
	 */
	public final static String getDataString(char typ, byte[] bytarray,
			int pos, int maxlen, boolean uni) {
	 ...
	 */
	public final static int getInt(byte[] buf, int pos)
	 ...
	 *                If there is not enough data in the buffer.
	 */
	public final static int getIntelInt(byte[] bytarray, int pos)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 *                If there is not enough data in the buffer.
	 */
	public final static long getIntelLong(byte[] bytarray, int pos)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 * @exception java.lang.IndexOutOfBoiundsException
	 *                If there is not enough data in the buffer.
	 */
	 ...
	 *                If there is not enough data in the buffer.
	 */
	public final static int getShort(byte[] bytarray, int pos)
			throws java.lang.IndexOutOfBoundsException {
	...
	/**
	 * Unpack a null terminated string from the data buffer. The string may be
	 * ASCII or Unicode.
	 * 
	 * @param bytarray
	 *            Byte array to unpack the string value from.
	 ...
	 */
	public final static void putInt(int val, byte[] bytarray, int pos)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 *                If there is not enough data in the buffer.
	 */
	public final static void putIntelInt(int val, byte[] bytarray, int pos)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 *                If there is not enough data in the buffer.
	 */
	public final static void putShort(int val, byte[] bytarray, int pos)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 */
	public final static int putString(String str, byte[] bytarray, int pos,
			boolean nullterm) {
	 ...
	 * @return The ending buffer position
	 */
	public final static int putString(String str, int fldLen, byte[] bytarray,
			int pos) {
	 ...
	 *            true if the string should be null terminated, else false
	 * @param isUni
	 *            true if the string should be packed as Unicode, false to pack
	 *            as ASCII
	 * @return The ending buffer position
	 */
	public final static int putString(String str, byte[] bytarray, int pos,
			boolean nullterm, boolean isUni) {
	 ...
	 * @return The ending buffer position
	 */
	public final static int putUnicodeString(String str, byte[] bytarray,
			int pos, boolean nullterm) {
	 ...
	 *                If the buffer does not have enough space.
	 */
	public final static void putZeros(byte[] buf, int pos, int cnt)
	...
	/**
	 * Calculate the new buffer position after the specified string and encoding
	 * (ASCII or Unicode)
	 * 
	 * @param pos
	 *            int
	 ...
	 * @return int
	 */
	public final static int getBufferPosition(int pos, String str, boolean uni,
			boolean nul) {
