...
public class FileInfo implements Serializable {
  ...
  // Set file information flags
  //
  // Used to indicate which values in the file information object are valid
   ...
   *          File attributes.
   * @param ftime
   *          File time, in seconds since 1-Jan-1970 00:00:00
   */
   ...
   *          File attributes.
   * @param fdate
   *          SMB encoded file date.
   * @param ftime
   *          SMB encoded file time.
   */
   ...
   *          SMB encoded file time.
   */
  public FileInfo(String fpath, String fname, long fsize, int fattr, int fdate,
      int ftime) {
    m_path = fpath;
    m_name = fname;
    m_size = fsize;
