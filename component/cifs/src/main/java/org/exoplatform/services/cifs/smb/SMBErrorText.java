 ...
 * <p>
 * The SMBErrorText is a static class that converts SMB error class/error codes
 * into their appropriate error message strings. The class is used by the
 * SMBException class when outputting an SMB exception as a string.
 * <p>
...
public final class SMBErrorText {
	...
	public final static String ErrorString(int errclass, int errcode) {
		...
		if (errtext == null)
			errtext = "[Unknown error status/class: " + errclass + ","
					+ errcode + "]";
