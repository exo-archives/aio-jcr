...
public class DialectSelector {
	 ...
	 * 
	 * @param idx
	 *            Index of the dialect to add to the available dialects.
	 * @exception java.lang.ArrayIndexOutOfBoundsException
	 *                Invalid dialect index.
	 */

	public void AddDialect(int d)
	 ...
	 * 
	 * @param idx
	 *            Index of the dialect to test for.
	 ...
	 * 
	 * @param idx
	 *            Index of the dialect to remove.
	 * @exception java.lang.ArrayIndexOutOfBoundsException
	 *                Invalid dialect index.
	 */

	public void RemoveDialect(int d)
			throws java.lang.ArrayIndexOutOfBoundsException {
		dialects.clear(d);
	}
