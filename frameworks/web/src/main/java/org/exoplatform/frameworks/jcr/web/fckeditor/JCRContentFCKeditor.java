...
public class JCRContentFCKeditor extends FCKeditor {
  ...
  public JCRContentFCKeditor(HttpServletRequest req, String parInstanceName, String workspaceName, String filePath, String newNodeType) 
   throws RepositoryException {
    ...
    ExoContainer container = (ExoContainer) req.getSession().getServletContext().getAttribute(WebConstants.EXO_CONTAINER); 
    if (container == null) {    //this
      String portalName = req.getSession().getServletContext().getServletContextName(); //req.getContextPath();
