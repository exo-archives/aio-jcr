...
public class PropPatchTest extends TestCase {
  ...
  public void testNotAuthorized() throws Exception {
    ...
    DavPropPatch davPropPatch = new DavPropPatch(DavLocationConst.getLocation());
  ...
  public void testNotFound() throws Exception {
    ...
    DavPropPatch davPropPatch = new DavPropPatch(DavLocationConst.getLocationAuthorized());
