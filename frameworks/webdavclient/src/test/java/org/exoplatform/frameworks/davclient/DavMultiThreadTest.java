  ...
  protected class TestDavClient extends Thread {
    ...
    public void run() {
      ...
      try {
        log("OPTIONS test...");        
        {
          DavOptions davOptions = new DavOptions(TestConst.getTestServerLocation());
          assertEquals(davOptions.execute(), Const.HttpStatus.OK);
        }        
        
        log("PROPFIND test...");
        {
          DavPropFind davPropFind = new DavPropFind(TestConst.getTestServerLocation());
        ...
        log("MKCOL test...");
        {
          DavMkCol davMkCol = new DavMkCol(TestConst.getTestServerLocation());
        ...
        for (int i1 = 0; i1 < FCOUNT; i1++) {
          for (int i2 = 0; i2 < FCOUNT; i2++) {                        
            for (int i3 = 0; i3 < FCOUNT; i3++) {
              ...
              DavPut davPut = new DavPut(TestConst.getTestServerLocation());
        ...
        for (int i1 = 0; i1 < FCOUNT; i1++) {
          for (int i2 = 0; i2 < FCOUNT; i2++) {                        
            for (int i3 = 0; i3 < FCOUNT; i3++) {
              ...
              DavGet davGet = new DavGet(TestConst.getTestServerLocation());
        ...
        for (int i1 = 0; i1 < FCOUNT; i1++) {
          ...
          for (int i2 = 0; i2 < FCOUNT; i2++) {                        
            ...
            for (int i3 = 0; i3 < FCOUNT; i3++) {
              ...
              DavDelete davDelete = new DavDelete(TestConst.getTestServerLocation());
