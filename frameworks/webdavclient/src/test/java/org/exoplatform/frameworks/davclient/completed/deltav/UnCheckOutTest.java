...
public class UnCheckOutTest extends TestCase {
  ...
  private static Log log = ExoLogger.getLogger("jcr.UnCheckOutTest");
  ...
  public void testNotAuthorized() throws Exception {
    ...
    DavUnCheckOut davUnCheckOut = new DavUnCheckOut(DavLocationConst.getLocation());
    davUnCheckOut.setResourcePath(SRC_NAME);    
  ...
  public void testNotFound() throws Exception {
    ...
    DavUnCheckOut davUnCheckOut = new DavUnCheckOut(DavLocationConst.getLocationAuthorized());
