...
public class AdditionalPropertiesTest extends TestCase {
  ...
  private static Log log = ExoLogger.getLogger("jcr.AdditionalPropertiesTest");
  
  private static final String ROOT_DIR = "/production";
  ...
  public void testAdditionalProperties() throws Exception {
        ...
        
    {
      ...
      davPropFind.setResourcePath(ROOT_DIR);
