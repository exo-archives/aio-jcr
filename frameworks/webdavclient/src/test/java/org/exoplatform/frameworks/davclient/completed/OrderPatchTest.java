...
import org.exoplatform.frameworks.davclient.commands.DavOrderPatch;
...
import org.exoplatform.frameworks.davclient.order.OrderConst;
...
public class OrderPatchTest extends TestCase {
  ...
  public void testOrderFirst() throws Exception {
    ...
    DavOrderPatch davOrderPatch = new DavOrderPatch(DavLocationConst.getLocationAuthorized());
