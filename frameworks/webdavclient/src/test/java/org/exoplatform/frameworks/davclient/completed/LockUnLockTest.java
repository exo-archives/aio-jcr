...
public class LockUnLockTest extends TestCase {
  ...
  public void testLockNotAuthorized() throws Exception {
    ...
    DavLock davLock = new DavLock(DavLocationConst.getLocation());
  ...
  public void testUnLockNotAuthorized() throws Exception {
    ...
    DavUnLock davUnLock = new DavUnLock(DavLocationConst.getLocation());
  ...
  public void testUnLockForbidden() throws Exception {
    ...
    DavUnLock davUnLock = new DavUnLock(DavLocationConst.getLocationAuthorized());
    davUnLock.setResourcePath(SRC_NAME);
  ...
  public void testLockWithBadRequest() throws Exception {
    ...
    davLock.setRequestDataBuffer("поганий ХМЛ буде збоїть".getBytes());
