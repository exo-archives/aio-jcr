...
public class DavVersionControl extends DavCommand {
  
  public DavVersionControl(ServerLocation location) throws Exception {
    super(location);
    commandName = Const.DavCommand.VERSIONCONTROL;
  }
