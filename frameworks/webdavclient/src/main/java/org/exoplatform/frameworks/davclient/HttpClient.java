...
public class HttpClient {
  ...
  private String httpRequestBodyStr = null;
  private byte []httpRequestBodyBytes = null;
...
//      return contLen;      
  ...
  public int execute() throws Exception {
    ...
    setRequestHeader(Const.HttpHeaders.CONTENTLENGTH, String.format("%s", reqContLength));    
