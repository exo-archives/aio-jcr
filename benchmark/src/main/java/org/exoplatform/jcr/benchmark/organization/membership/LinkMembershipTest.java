 ...
 */
public class LinkMembershipTest extends AbstractMembershipTest {

  @Override
  public void doPrepare(TestCase tc, JCRTestContext context) throws Exception {
    super.doPrepare(tc, context);
    super.createContent(false);
  }

  @Override
  public void doRun(TestCase tc, JCRTestContext context) throws Exception {
    mHandler.linkMembership(nextUser(), nextGroup(), nextMembershipType(), false);
  }
}
