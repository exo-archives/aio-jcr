...
public class PropertySetValueValueArrrayTest extends AbstractGetItemTest {

  private Value[] value = new Value[1];

  @Override
  protected void createContent(Node parent, TestCase tc, JCRTestContext context) throws Exception {
    value[0] = context.getSession().getValueFactory().createValue("testValue");
