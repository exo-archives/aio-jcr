 ...
 * @version $Id: $
 */
public class UpdateExistedNodeTypeValue extends AbstractNodeTypeTest {
  /**
   * Class logger.
   */
  private static final Log LOG = ExoLogger.getLogger(UpdateExistedNodeTypeValue.class);
  ...
  public void doRun(TestCase arg0, JCRTestContext context) throws Exception {
    ...
    nodeTypeValue.setOrderableChild(true);
  ...
  public void prepare(TestCase arg0, JCRTestContext context) throws Exception {
    ...
    for (int i = 0; i < runIterations; i++) {
      ...
      extNodeTypeManager = (ExtendedNodeTypeManager) context.getSession()
                                                            .getWorkspace()
                                                            .getNodeTypeManager();
      ...
      nodeTypeValue.setName(context.generateUniqueName("exo:updateExistedNodeTypeValue"));
      nodeTypeValue.setPrimaryItemName("child");
