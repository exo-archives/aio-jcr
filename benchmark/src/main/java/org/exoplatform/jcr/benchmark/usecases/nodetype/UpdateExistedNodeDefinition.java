 ...
 * @version $Id: $
 */
public class UpdateExistedNodeDefinition extends AbstractNodeTypeTest {
  /**
   * Class logger.
   */
  private static final Log LOG = ExoLogger.getLogger(UpdateExistedNodeDefinition.class);
  ...
  public void prepare(TestCase arg0, JCRTestContext context) throws Exception {
    ...
    for (int i = 0; i < runIterations; i++) {
      ...
      nodeTypeValue.setName(context.generateUniqueName("exo:updateExistedNodeDefinition"));
