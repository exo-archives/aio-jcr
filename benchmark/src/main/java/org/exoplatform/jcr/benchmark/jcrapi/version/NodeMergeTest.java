...
public class NodeMergeTest extends AbstractGetItemTest {
  ...
  protected void createContent(Node parent, TestCase tc, JCRTestContext context) throws Exception {
    ...
    sysSession = context.getSession()
                        .getRepository()
                        .login(context.getCredentials(), workspaceName);
    ...
    sysSession.getWorkspace().clone(context.getSession().getWorkspace().getName(),
                                    vnode.getPath(),
                                    vnode.getPath(),
                                    false);
