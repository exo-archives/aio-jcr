 ...
 * @version $Id: $
 */
public class UpdateExistedPropertyDefinition extends AbstractNodeTypeTest {
  /**
   * Class logger.
   */
  private static final Log LOG = ExoLogger.getLogger(UpdateExistedPropertyDefinition.class);
  ...
  public void prepare(TestCase arg0, JCRTestContext context) throws Exception {
    ...
    for (int i = 0; i < runIterations; i++) {
      ...
      nodeTypeValue.setName(context.generateUniqueName("exo:updateExistedPropertyDefinition"));
