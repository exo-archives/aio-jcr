 ...
 * @version $Id: $
 */
public class ChangeExistedPropertyDefinition extends AbstractNodeTypeTest {
  /**
   * Class logger.
   */
  private static final Log LOG = ExoLogger.getLogger(ChangeExistedPropertyDefinition.class);
  ...
  public void prepare(TestCase arg0, JCRTestContext context) throws Exception {
    ...
    for (int i = 0; i < runIterations; i++) {
      ...
      nodeTypeValue.setName(context.generateUniqueName("exo:changeExistedPropertyDefinition"));
