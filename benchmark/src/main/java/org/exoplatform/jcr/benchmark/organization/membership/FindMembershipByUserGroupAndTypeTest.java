 ...
 */
public class FindMembershipByUserGroupAndTypeTest extends AbstractMembershipTest {
  ...
  public void doRun(TestCase tc, JCRTestContext context) throws Exception {
    mHandler.findMembershipByUserGroupAndType(nextUser().getUserName(), "/"
        + nextGroup().getGroupName(), nextMembershipType().getName());
  }
}
