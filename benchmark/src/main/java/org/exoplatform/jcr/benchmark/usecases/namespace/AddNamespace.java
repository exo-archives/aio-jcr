 ...
 * @version $Id: $
 */
public class AddNamespace extends AbstractNamespaceTest {
  /**
   * Class logger.
   */
  private static final Log LOG = ExoLogger.getLogger(AddNamespace.class);
  ...
  @Override
  public void prepare(TestCase arg0, JCRTestContext arg1) throws Exception {
  }
