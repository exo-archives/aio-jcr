JCR 1.10.4 release notes
========================

This is a Enterprise Edition version of 1.10 JCR. 
Version 1.10.4 includes all 1.10.3 features improvements of JCR replication in proxy mode. It also contains backports of 
VersionHistory export/import tool and large files (> 2GiB) support.
