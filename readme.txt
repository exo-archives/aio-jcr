JCR 1.9.3.1 release notes
=========================

JCR 1.9.3.1 it's a customer patch.
...
Property edit operations improved on 20 percents.
Value edit operations improved on 60 percents.
Remove operations improved on 40 percents.
Move operations improved in 14 times.
Also good result for XML import/export and Versions operations.

See details on http://tests.exoplatform.org


JCR 1.9.3 changes after JCR 1.9.2
...
- WebDAV EJB connector for ejb 2.1.
- WebDAV EJB connector for ejb 3.0.
